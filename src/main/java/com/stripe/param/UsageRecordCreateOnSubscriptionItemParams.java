...
public class UsageRecordCreateOnSubscriptionItemParams
    ...
    UsageRecordCreateOnSubscriptionItemParams.Action action;
    ...
    public static UsageRecordCreateOnSubscriptionItemParams.Builder builder() {
        return new UsageRecordCreateOnSubscriptionItemParams.Builder();
    }
    public static class Builder {
        private UsageRecordCreateOnSubscriptionItemParams.Action action;
         ...
         * Valid values are `increment` (default) or `set`. When using `increment` the specified `quantity` will be added to the usage at the specified timestamp. The `set` action will overwrite the usage quantity at that timestamp. If the subscription has [billing thresholds](https://stripe.com/docs/api/subscriptions/object#subscription_object-billing_thresholds), `increment` is the only allowed value.
         */
        public UsageRecordCreateOnSubscriptionItemParams.Builder setAction(
            UsageRecordCreateOnSubscriptionItemParams.Action action) {
         ...
         */
        public UsageRecordCreateOnSubscriptionItemParams.Builder addExpand(
            String element) {
         ...
         */
        public UsageRecordCreateOnSubscriptionItemParams.Builder addAllExpand(
            List<String> list) {
         ...
         */
        public UsageRecordCreateOnSubscriptionItemParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public UsageRecordCreateOnSubscriptionItemParams.Builder putAllExtraParam(
         ...
         * The usage quantity for the specified timestamp.
         */
        public UsageRecordCreateOnSubscriptionItemParams.Builder setQuantity(
            Long quantity) {
         ...
         * The timestamp for the usage event. This timestamp must be within the current billing period of the subscription of the provided `subscription_item`.
         */
        public UsageRecordCreateOnSubscriptionItemParams.Builder setTimestamp(
            Long timestamp) {
