...
public class PersonCollectionCreateParams extends ApiRequestParams {
    ...
    public static class Builder {
         ...
         * The person's date of birth.
         */
        public PersonCollectionCreateParams.Builder setDob(
            PersonCollectionCreateParams.Dob dob) {
         ...
         */
        public PersonCollectionCreateParams.Builder addAllExpand(
            List<String> list) {
         ...
         */
        public PersonCollectionCreateParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public PersonCollectionCreateParams.Builder putAllExtraParam(
         ...
         * The person's first name.
         */
        public PersonCollectionCreateParams.Builder setFirstName(
            String firstName) {
         ...
         * The Kana variation of the person's first name (Japan only).
         */
        public PersonCollectionCreateParams.Builder setFirstNameKana(
            String firstNameKana) {
         ...
         * The Kanji variation of the person's first name (Japan only).
         */
        public PersonCollectionCreateParams.Builder setFirstNameKanji(
            String firstNameKanji) {
         ...
         * The person's ID number, as appropriate for their country. For example, a social security number in the U.S., social insurance number in Canada, etc. Instead of the number itself, you can also provide a [PII token provided by Stripe.js](https://stripe.com/docs/stripe.js#collecting-pii-data).
         */
        public PersonCollectionCreateParams.Builder setIdNumber(
            String idNumber) {
         ...
         * The person's last name.
         */
        public PersonCollectionCreateParams.Builder setLastName(
            String lastName) {
         ...
         * The Kana variation of the person's last name (Japan only).
         */
        public PersonCollectionCreateParams.Builder setLastNameKana(
            String lastNameKana) {
         ...
         * The Kanji variation of the person's last name (Japan only).
         */
        public PersonCollectionCreateParams.Builder setLastNameKanji(
            String lastNameKanji) {
         ...
         * The person's maiden name.
         */
        public PersonCollectionCreateParams.Builder setMaidenName(
            String maidenName) {
         ...
         */
        public PersonCollectionCreateParams.Builder putMetadata(
            String key,
            String value) {
         ...
         */
        public PersonCollectionCreateParams.Builder putAllMetadata(
         ...
         * A [person token](https://stripe.com/docs/connect/account-tokens), used to securely provide details to the person.
         */
        public PersonCollectionCreateParams.Builder setPersonToken(
            String personToken) {
         ...
         * The last 4 digits of the person's social security number.
         */
        public PersonCollectionCreateParams.Builder setSsnLast4(
            String ssnLast4) {
    ...
    public static class Address {
        ...
        public static class Builder {
             ...
             * City, district, suburb, town, or village.
             */
            public PersonCollectionCreateParams.Address.Builder setCity(
                String city) {
             ...
             * Two-letter country code ([ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)).
             */
            public PersonCollectionCreateParams.Address.Builder setCountry(
                String country) {
             ...
             */
            public PersonCollectionCreateParams.Address.Builder putExtraParam(
                String key,
                Object value) {
             ...
             * Address line 1 (e.g., street, PO Box, or company name).
             */
            public PersonCollectionCreateParams.Address.Builder setLine1(
                String line1) {
             ...
             * Address line 2 (e.g., apartment, suite, unit, or building).
             */
            public PersonCollectionCreateParams.Address.Builder setLine2(
                String line2) {
             ...
             * ZIP or postal code.
             */
            public PersonCollectionCreateParams.Address.Builder setPostalCode(
                String postalCode) {
             ...
             * State, county, province, or region.
             */
            public PersonCollectionCreateParams.Address.Builder setState(
                String state) {
    ...
    public static class AddressKana {
        ...
        public static class Builder {
             ...
             * City or ward.
             */
            public PersonCollectionCreateParams.AddressKana.Builder setCity(
                String city) {
             ...
             * Two-letter country code ([ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)).
             */
            public PersonCollectionCreateParams.AddressKana.Builder setCountry(
                String country) {
             ...
             * Block or building number.
             */
            public PersonCollectionCreateParams.AddressKana.Builder setLine1(
                String line1) {
             ...
             * Building details.
             */
            public PersonCollectionCreateParams.AddressKana.Builder setLine2(
                String line2) {
             ...
             * Postal code.
             */
            public PersonCollectionCreateParams.AddressKana.Builder setPostalCode(
                String postalCode) {
             ...
             * Prefecture.
             */
            public PersonCollectionCreateParams.AddressKana.Builder setState(
                String state) {
             ...
             * Town or cho-me.
             */
            public PersonCollectionCreateParams.AddressKana.Builder setTown(
                String town) {
    ...
    public static class AddressKanji {
        ...
        public static class Builder {
             ...
             * City or ward.
             */
            public PersonCollectionCreateParams.AddressKanji.Builder setCity(
                String city) {
             ...
             * Two-letter country code ([ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)).
             */
            public PersonCollectionCreateParams.AddressKanji.Builder setCountry(
                String country) {
             ...
             * Block or building number.
             */
            public PersonCollectionCreateParams.AddressKanji.Builder setLine1(
                String line1) {
             ...
             * Building details.
             */
            public PersonCollectionCreateParams.AddressKanji.Builder setLine2(
                String line2) {
             ...
             * Postal code.
             */
            public PersonCollectionCreateParams.AddressKanji.Builder setPostalCode(
                String postalCode) {
             ...
             * Prefecture.
             */
            public PersonCollectionCreateParams.AddressKanji.Builder setState(
                String state) {
             ...
             * Town or cho-me.
             */
            public PersonCollectionCreateParams.AddressKanji.Builder setTown(
                String town) {
    ...
    public static class Dob {
        ...
        public static class Builder {
             ...
             */
            public PersonCollectionCreateParams.Dob.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public PersonCollectionCreateParams.Dob.Builder putAllExtraParam(
                Map<String, Object> map) {
             ...
             * The month of birth, between 1 and 12.
             */
            public PersonCollectionCreateParams.Dob.Builder setMonth(
                Long month) {
    ...
    public static class Relationship {
        ...
        public static class Builder {
             ...
             * Whether the person is a director of the account's legal entity. Currently only required for accounts in the EU. Directors are typically members of the governing board of the company, or responsible for ensuring the company meets its regulatory obligations.
             */
            public PersonCollectionCreateParams.Relationship.Builder setDirector(
                Boolean director) {
             ...
             * Whether the person is an owner of the account’s legal entity.
             */
            public PersonCollectionCreateParams.Relationship.Builder setOwner(
                Boolean owner) {
             ...
             * The person's title (e.g., CEO, Support Engineer).
             */
            public PersonCollectionCreateParams.Relationship.Builder setTitle(
                String title) {
    ...
    public static class Verification {
        ...
        public static class Document {
            ...
            public static class Builder {
                 ...
                 * The back of an ID returned by a [file upload](#create_file) with a `purpose` value of `identity_document`.
                 */
                public PersonCollectionCreateParams.Verification.Document.Builder setBack(
                    String back) {
                 ...
                 * The front of an ID returned by a [file upload](#create_file) with a `purpose` value of `identity_document`.
                 */
                public PersonCollectionCreateParams.Verification.Document.Builder setFront(
                    String front) {
