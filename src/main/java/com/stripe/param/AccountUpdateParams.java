...
public class AccountUpdateParams extends ApiRequestParams {
    ...
    public static class Builder {
         ...
         * An [account token](https://stripe.com/docs/api#create_account_token), used to securely provide details to the account.
         */
        public AccountUpdateParams.Builder setAccountToken(
            String accountToken) {
         ...
         * The business type. Can be `individual` or `company`.
         */
        public AccountUpdateParams.Builder setBusinessType(
            String businessType) {
         ...
         * Information about the company or business. This field is null unless `business_type` is set to `company`.
         */
        public AccountUpdateParams.Builder setCompany(
            AccountUpdateParams.Company company) {
         ...
         * Three-letter ISO currency code representing the default currency for the account. This must be a currency that [Stripe supports in the account's country](https://stripe.com/docs/payouts).
         */
        public AccountUpdateParams.Builder setDefaultCurrency(
            String defaultCurrency) {
         ...
         * A card or bank account to attach to the account. You can provide either a token, like the ones returned by [Stripe.js](https://stripe.com/docs/stripe.js), or a dictionary, as documented in the `external_account` parameter for [bank account](https://stripe.com/docs/api#account_create_bank_account) creation. <br><br>By default, providing an external account sets it as the new default external account for its currency, and deletes the old default if one exists. To add additional external accounts without replacing the existing default for the currency, use the bank account or card creation API.
         */
        public AccountUpdateParams.Builder setExternalAccount(
            String externalAccount) {
         ...
         */
        public AccountUpdateParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public AccountUpdateParams.Builder putAllExtraParam(
         ...
         * Information about the person represented by the account. This field is null unless `business_type` is set to `individual`.
         */
        public AccountUpdateParams.Builder setIndividual(
            AccountUpdateParams.Individual individual) {
         ...
         */
        public AccountUpdateParams.Builder putMetadata(
            String key,
            String value) {
         ...
         */
        public AccountUpdateParams.Builder putAllMetadata(
        ...
        /**
         * Add an element to `requestedCapabilities` list. A list is initialized for the first `add/addAll` call, and subsequent calls adds additional elements to the original list. See {@link AccountUpdateParams#requestedCapabilities} for the field documentation.
         */
        ...
        /**
         * Add all elements to `requestedCapabilities` list. A list is initialized for the first `add/addAll` call, and subsequent calls adds additional elements to the original list. See {@link AccountUpdateParams#requestedCapabilities} for the field documentation.
         */
         ...
         * Options for customizing how the account functions within Stripe.
         */
        public AccountUpdateParams.Builder setSettings(
            AccountUpdateParams.Settings settings) {
    ...
    public static class BusinessProfile {
        ...
        public static class Builder {
             ...
             */
            public AccountUpdateParams.BusinessProfile.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public AccountUpdateParams.BusinessProfile.Builder putAllExtraParam(
                Map<String, Object> map) {
             ...
             * The merchant category code for the account. MCCs are used to classify businesses based on the goods or services they provide.
             */
            public AccountUpdateParams.BusinessProfile.Builder setMcc(
                String mcc) {
             ...
             * The customer-facing business name.
             */
            public AccountUpdateParams.BusinessProfile.Builder setName(
                String name) {
             ...
             * A publicly available email address for sending support issues to.
             */
            public AccountUpdateParams.BusinessProfile.Builder setSupportEmail(
                String supportEmail) {
             ...
             * A publicly available phone number to call with support issues.
             */
            public AccountUpdateParams.BusinessProfile.Builder setSupportPhone(
                String supportPhone) {
             ...
             * A publicly available website for handling support issues.
             */
            public AccountUpdateParams.BusinessProfile.Builder setSupportUrl(
                String supportUrl) {
             ...
             * The business's publicly available website.
             */
            public AccountUpdateParams.BusinessProfile.Builder setUrl(
                String url) {
    ...
    public static class Company {
        ...
        public static class Builder {
             ...
             * Whether the company's directors have been provided. Set this Boolean to `true` after creating all the company's directors with [the Persons API](https://stripe.com/docs/api/persons) for accounts with a `relationship.director` requirement. This value is not automatically set to `true` after creating directors, so it needs to be updated to indicate all directors have been provided.
             */
            public AccountUpdateParams.Company.Builder setDirectorsProvided(
                Boolean directorsProvided) {
             ...
             */
            public AccountUpdateParams.Company.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public AccountUpdateParams.Company.Builder putAllExtraParam(
                Map<String, Object> map) {
             ...
             * The Kana variation of the company's legal name (Japan only).
             */
            public AccountUpdateParams.Company.Builder setNameKana(
                String nameKana) {
             ...
             * The Kanji variation of the company's legal name (Japan only).
             */
            public AccountUpdateParams.Company.Builder setNameKanji(
                String nameKanji) {
             ...
             * Whether the company's owners have been provided. Set this Boolean to `true` after creating all the company's owners with [the Persons API](https://stripe.com/docs/api/persons) for accounts with a `relationship.owner` requirement.
             */
            public AccountUpdateParams.Company.Builder setOwnersProvided(
                Boolean ownersProvided) {
             ...
             * The jurisdiction in which the `tax_id` is registered (Germany-based companies only).
             */
            public AccountUpdateParams.Company.Builder setTaxIdRegistrar(
                String taxIdRegistrar) {
        ...
        public static class Address {
            ...
            public static class Builder {
                 ...
                 * City, district, suburb, town, or village.
                 */
                public AccountUpdateParams.Company.Address.Builder setCity(
                    String city) {
                 ...
                 * Two-letter country code ([ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)).
                 */
                public AccountUpdateParams.Company.Address.Builder setCountry(
                    String country) {
                 ...
                 */
                public AccountUpdateParams.Company.Address.Builder putExtraParam(
                    String key,
                    Object value) {
                 ...
                 * Address line 1 (e.g., street, PO Box, or company name).
                 */
                public AccountUpdateParams.Company.Address.Builder setLine1(
                    String line1) {
                 ...
                 * Address line 2 (e.g., apartment, suite, unit, or building).
                 */
                public AccountUpdateParams.Company.Address.Builder setLine2(
                    String line2) {
                 ...
                 * ZIP or postal code.
                 */
                public AccountUpdateParams.Company.Address.Builder setPostalCode(
                    String postalCode) {
                 ...
                 * State, county, province, or region.
                 */
                public AccountUpdateParams.Company.Address.Builder setState(
                    String state) {
        ...
        public static class AddressKana {
            ...
            public static class Builder {
                 ...
                 * City or ward.
                 */
                public AccountUpdateParams.Company.AddressKana.Builder setCity(
                    String city) {
                 ...
                 * Two-letter country code ([ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)).
                 */
                public AccountUpdateParams.Company.AddressKana.Builder setCountry(
                    String country) {
                 ...
                 * Block or building number.
                 */
                public AccountUpdateParams.Company.AddressKana.Builder setLine1(
                    String line1) {
                 ...
                 * Building details.
                 */
                public AccountUpdateParams.Company.AddressKana.Builder setLine2(
                    String line2) {
                 ...
                 * Postal code.
                 */
                public AccountUpdateParams.Company.AddressKana.Builder setPostalCode(
                    String postalCode) {
                 ...
                 * Prefecture.
                 */
                public AccountUpdateParams.Company.AddressKana.Builder setState(
                    String state) {
                 ...
                 * Town or cho-me.
                 */
                public AccountUpdateParams.Company.AddressKana.Builder setTown(
                    String town) {
        ...
        public static class AddressKanji {
            ...
            public static class Builder {
                 ...
                 * City or ward.
                 */
                public AccountUpdateParams.Company.AddressKanji.Builder setCity(
                    String city) {
                 ...
                 * Two-letter country code ([ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)).
                 */
                public AccountUpdateParams.Company.AddressKanji.Builder setCountry(
                    String country) {
                 ...
                 * Block or building number.
                 */
                public AccountUpdateParams.Company.AddressKanji.Builder setLine1(
                    String line1) {
                 ...
                 * Building details.
                 */
                public AccountUpdateParams.Company.AddressKanji.Builder setLine2(
                    String line2) {
                 ...
                 * Postal code.
                 */
                public AccountUpdateParams.Company.AddressKanji.Builder setPostalCode(
                    String postalCode) {
                 ...
                 * Prefecture.
                 */
                public AccountUpdateParams.Company.AddressKanji.Builder setState(
                    String state) {
                 ...
                 * Town or cho-me.
                 */
                public AccountUpdateParams.Company.AddressKanji.Builder setTown(
                    String town) {
    ...
    public static class Individual {
        ...
        public static class Builder {
             ...
             * The individual's date of birth.
             */
            public AccountUpdateParams.Individual.Builder setDob(
                AccountUpdateParams.Individual.Dob dob) {

                this.dob = dob;
                return this;
            }
            public AccountUpdateParams.Individual.Builder setEmail(
                String email) {
             ...
             */
            public AccountUpdateParams.Individual.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public AccountUpdateParams.Individual.Builder putAllExtraParam(
                Map<String, Object> map) {
             ...
             * The individual's first name.
             */
            public AccountUpdateParams.Individual.Builder setFirstName(
                String firstName) {
             ...
             * The Kana variation of the the individual's first name (Japan only).
             */
            public AccountUpdateParams.Individual.Builder setFirstNameKana(
                String firstNameKana) {
             ...
             * The Kanji variation of the individual's first name (Japan only).
             */
            public AccountUpdateParams.Individual.Builder setFirstNameKanji(
                String firstNameKanji) {
             ...
             * The individual's gender (International regulations require either "male" or "female").
             */
            public AccountUpdateParams.Individual.Builder setGender(
                String gender) {
             ...
             * The government-issued ID number of the individual, as appropriate for the representative’s country. (Examples are a Social Security Number in the U.S., or a Social Insurance Number in Canada). Instead of the number itself, you can also provide a [PII token created with Stripe.js](https://stripe.com/docs/stripe.js#collecting-pii-data).
             */
            public AccountUpdateParams.Individual.Builder setIdNumber(
                String idNumber) {
             ...
             * The individual's last name.
             */
            public AccountUpdateParams.Individual.Builder setLastName(
                String lastName) {
             ...
             * The Kana varation of the individual's last name (Japan only).
             */
            public AccountUpdateParams.Individual.Builder setLastNameKana(
                String lastNameKana) {
             ...
             * The Kanji varation of the individual's last name (Japan only).
             */
            public AccountUpdateParams.Individual.Builder setLastNameKanji(
                String lastNameKanji) {
             ...
             * The individual's maiden name.
             */
            public AccountUpdateParams.Individual.Builder setMaidenName(
                String maidenName) {
             ...
             */
            public AccountUpdateParams.Individual.Builder putMetadata(
                String key,
                String value) {
             ...
             */
            public AccountUpdateParams.Individual.Builder putAllMetadata(
                Map<String, String> map) {
             ...
             * The individual's phone number.
             */
            public AccountUpdateParams.Individual.Builder setPhone(
                String phone) {
             ...
             * The last four digits of the individual's Social Security Number (U.S. only).
             */
            public AccountUpdateParams.Individual.Builder setSsnLast4(
                String ssnLast4) {
        ...
        public static class Address {
            ...
            public static class Builder {
                 ...
                 * City, district, suburb, town, or village.
                 */
                public AccountUpdateParams.Individual.Address.Builder setCity(
                    String city) {
                 ...
                 * Two-letter country code ([ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)).
                 */
                public AccountUpdateParams.Individual.Address.Builder setCountry(
                    String country) {
                 ...
                 * Address line 1 (e.g., street, PO Box, or company name).
                 */
                public AccountUpdateParams.Individual.Address.Builder setLine1(
                    String line1) {
                 ...
                 * Address line 2 (e.g., apartment, suite, unit, or building).
                 */
                public AccountUpdateParams.Individual.Address.Builder setLine2(
                    String line2) {
                 ...
                 * ZIP or postal code.
                 */
                public AccountUpdateParams.Individual.Address.Builder setPostalCode(
                    String postalCode) {
                 ...
                 * State, county, province, or region.
                 */
                public AccountUpdateParams.Individual.Address.Builder setState(
                    String state) {
        ...
        public static class AddressKana {
            ...
            public static class Builder {
                 ...
                 * City or ward.
                 */
                public AccountUpdateParams.Individual.AddressKana.Builder setCity(
                    String city) {
                 ...
                 * Two-letter country code ([ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)).
                 */
                public AccountUpdateParams.Individual.AddressKana.Builder setCountry(
                    String country) {
                 ...
                 * Block or building number.
                 */
                public AccountUpdateParams.Individual.AddressKana.Builder setLine1(
                    String line1) {
                 ...
                 * Building details.
                 */
                public AccountUpdateParams.Individual.AddressKana.Builder setLine2(
                    String line2) {
                 ...
                 * Postal code.
                 */
                public AccountUpdateParams.Individual.AddressKana.Builder setPostalCode(
                    String postalCode) {
                 ...
                 * Prefecture.
                 */
                public AccountUpdateParams.Individual.AddressKana.Builder setState(
                    String state) {
                 ...
                 * Town or cho-me.
                 */
                public AccountUpdateParams.Individual.AddressKana.Builder setTown(
                    String town) {
        ...
        public static class AddressKanji {
            ...
            public static class Builder {
                 ...
                 * City or ward.
                 */
                public AccountUpdateParams.Individual.AddressKanji.Builder setCity(
                    String city) {
                 ...
                 * Two-letter country code ([ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)).
                 */
                public AccountUpdateParams.Individual.AddressKanji.Builder setCountry(
                    String country) {
                 ...
                 * Block or building number.
                 */
                public AccountUpdateParams.Individual.AddressKanji.Builder setLine1(
                    String line1) {
                 ...
                 * Building details.
                 */
                public AccountUpdateParams.Individual.AddressKanji.Builder setLine2(
                    String line2) {
                 ...
                 * Prefecture.
                 */
                public AccountUpdateParams.Individual.AddressKanji.Builder setState(
                    String state) {
                 ...
                 * Town or cho-me.
                 */
                public AccountUpdateParams.Individual.AddressKanji.Builder setTown(
                    String town) {
        ...
        public static class Dob {
            ...
            public static class Builder {
                 ...
                 * The day of birth, between 1 and 31.
                 */
                public AccountUpdateParams.Individual.Dob.Builder setDay(
                    Long day) {
                 ...
                 */
                public AccountUpdateParams.Individual.Dob.Builder putExtraParam(
                    String key,
                    Object value) {
                 ...
                 * The month of birth, between 1 and 12.
                 */
                public AccountUpdateParams.Individual.Dob.Builder setMonth(
                    Long month) {
                 ...
                 * The four-digit year of birth.
                 */
                public AccountUpdateParams.Individual.Dob.Builder setYear(
                    Long year) {
        ...
        public static class Verification {
            ...
            public static class Document {
                ...
                public static class Builder {
                     ...
                     * The back of an ID returned by a [file upload](#create_file) with a `purpose` value of `identity_document`.
                     */
                    public AccountUpdateParams.Individual.Verification.Document.Builder setBack(
                        String back) {
    ...
    public static class Settings {
        ...
        public static class Builder {
             ...
             */
            public AccountUpdateParams.Settings.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public AccountUpdateParams.Settings.Builder putAllExtraParam(
                Map<String, Object> map) {
        ...
        public static class Branding {
            ...
            public static class Builder {
                 ...
                 * (ID of a [file upload](https://stripe.com/docs/guides/file-upload)) An icon for the account. Must be square and at least 128px x 128px.
                 */
                public AccountUpdateParams.Settings.Branding.Builder setIcon(
                    String icon) {
                 ...
                 * (ID of a [file upload](https://stripe.com/docs/guides/file-upload)) A logo for the account that will be used in Checkout instead of the icon and without the account's name next to it if provided. Must be at least 128px x 128px.
                 */
                public AccountUpdateParams.Settings.Branding.Builder setLogo(
                    String logo) {
                 ...
                 * A CSS hex color value representing the primary branding color for this account.
                 */
                public AccountUpdateParams.Settings.Branding.Builder setPrimaryColor(
                    String primaryColor) {
    ...
    public static class TosAcceptance {
        ...
        public static class Builder {
             ...
             * The Unix timestamp marking when the account representative accepted the Stripe Services Agreement.
             */
            public AccountUpdateParams.TosAcceptance.Builder setDate(
                Long date) {
             ...
             */
            public AccountUpdateParams.TosAcceptance.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public AccountUpdateParams.TosAcceptance.Builder putAllExtraParam(
                Map<String, Object> map) {
             ...
             * The user agent of the browser from which the account representative accepted the Stripe Services Agreement.
             */
            public AccountUpdateParams.TosAcceptance.Builder setUserAgent(
                String userAgent) {
