...
public class InvoiceItemUpdateParams extends ApiRequestParams {
    ...
    InvoiceItemUpdateParams.Period period;
    ...
    public static InvoiceItemUpdateParams.Builder builder() {
        return new InvoiceItemUpdateParams.Builder();
    }
    public static class Builder {
        ...
        private InvoiceItemUpdateParams.Period period;
         ...
         * An arbitrary string which you can attach to the invoice item. The description is displayed in the invoice for easy tracking.
         */
        public InvoiceItemUpdateParams.Builder setDescription(
            String description) {
         ...
         * Controls whether discounts apply to this invoice item. Defaults to false for prorations or negative invoice items, and true for all other invoice items. Cannot be set to true for prorations.
         */
        public InvoiceItemUpdateParams.Builder setDiscountable(
            Boolean discountable) {
         ...
         */
        public InvoiceItemUpdateParams.Builder addAllExpand(List<String> list) {
            if (this.expand == null) {
                this.expand = new ArrayList<>();
            }
         ...
         */
        public InvoiceItemUpdateParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public InvoiceItemUpdateParams.Builder putAllExtraParam(
         ...
         */
        public InvoiceItemUpdateParams.Builder putMetadata(
            String key,
            String value) {
         ...
         */
        public InvoiceItemUpdateParams.Builder putAllMetadata(
         ...
         * The period associated with this invoice item.
         */
        public InvoiceItemUpdateParams.Builder setPeriod(
            InvoiceItemUpdateParams.Period period) {
         ...
         * The tax rates which apply to the invoice item. When set, the `default_tax_rates` on the invoice do not apply to this invoice item.
         */
        public InvoiceItemUpdateParams.Builder setTaxRates(
    ...
    public static class Period {
        ...
        public static InvoiceItemUpdateParams.Period.Builder builder() {
            return new InvoiceItemUpdateParams.Period.Builder();
        }
        public static class Builder {
            private Long end;
            private Map<String, Object> extraParams;
            ...
            public InvoiceItemUpdateParams.Period build() {
                return new InvoiceItemUpdateParams.Period(
                    this.end,
                    this.extraParams,
                    this.start
                );
             ...
             * The end of the period, which must be greater than or equal to the start.
             */
            public InvoiceItemUpdateParams.Period.Builder setEnd(Long end) {
                this.end = end;
                return this;
            }
             ...
             */
            public InvoiceItemUpdateParams.Period.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public InvoiceItemUpdateParams.Period.Builder putAllExtraParam(
                Map<String, Object> map) {
             ...
             * The start of the period.
             */
            public InvoiceItemUpdateParams.Period.Builder setStart(Long start) {
                this.start = start;
                return this;
            }
