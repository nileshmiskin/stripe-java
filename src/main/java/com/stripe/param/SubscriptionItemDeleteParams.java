...
public class SubscriptionItemDeleteParams extends ApiRequestParams {
    ...
    public static SubscriptionItemDeleteParams.Builder builder() {
        return new SubscriptionItemDeleteParams.Builder();
    }
    public static class Builder {
         ...
         * Delete all usage for the given subscription item. Allowed only when the current plan's `usage_type` is `metered`.
         */
        public SubscriptionItemDeleteParams.Builder setClearUsage(
            Boolean clearUsage) {
         ...
         */
        public SubscriptionItemDeleteParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public SubscriptionItemDeleteParams.Builder putAllExtraParam(
         ...
         * Flag indicating whether to [prorate](https://stripe.com/docs/billing/subscriptions/prorations) switching plans during a billing cycle.
         */
        public SubscriptionItemDeleteParams.Builder setProrate(
            Boolean prorate) {
         ...
         * If set, the proration will be calculated as though the subscription was updated at the given time. This can be used to apply the same proration that was previewed with the [upcoming invoice](#retrieve_customer_invoice) endpoint.
         */
        public SubscriptionItemDeleteParams.Builder setProrationDate(
            Long prorationDate) {
