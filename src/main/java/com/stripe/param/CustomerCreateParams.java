...
public class CustomerCreateParams extends ApiRequestParams {
    ...
    public static class Builder {
         ...
         * An integer amount in %s that represents the account balance for your customer. Account balances only affect invoices. A negative amount represents a credit that decreases the amount due on an invoice; a positive amount increases the amount due on an invoice.
         */
        public CustomerCreateParams.Builder setAccountBalance(
            Long accountBalance) {
         ...
         * The customer's address.
         */
        public CustomerCreateParams.Builder setAddress(
         ...
         */
        public CustomerCreateParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public CustomerCreateParams.Builder putAllExtraParam(
         ...
         * The prefix for the customer used to generate unique invoice numbers. Must be 3–12 uppercase letters or numbers.
         */
        public CustomerCreateParams.Builder setInvoicePrefix(
            String invoicePrefix) {
         ...
         */
        public CustomerCreateParams.Builder putMetadata(
            String key,
            String value) {
         ...
         */
        public CustomerCreateParams.Builder putAllMetadata(
        ...
        public CustomerCreateParams.Builder setPaymentMethod(
            String paymentMethod) {
         ...
         */
        public CustomerCreateParams.Builder addAllPreferredLocale(
            List<String> list) {
         ...
         * The customer's shipping information. Appears on invoices emailed to this customer.
         */
        public CustomerCreateParams.Builder setShipping(
            CustomerCreateParams.Shipping shipping) {
         ...
         * The customer's tax exemption. One of `none`, `exempt`, or `reverse`.
         */
        public CustomerCreateParams.Builder setTaxExempt(
            CustomerCreateParams.TaxExempt taxExempt) {
         ...
         */
        public CustomerCreateParams.Builder addTaxIdData(
            CustomerCreateParams.TaxIdData element) {
         ...
         */
        public CustomerCreateParams.Builder addAllTaxIdData(
            List<CustomerCreateParams.TaxIdData> list) {
         ...
         * The customer's tax information. Appears on invoices emailed to this customer. This parameter has been deprecated and will be removed in a future API version, for further information view the [migration guide](https://stripe.com/docs/billing/migration/taxes#moving-from-taxinfo-to-customer-tax-ids).
         */
        public CustomerCreateParams.Builder setTaxInfo(
            CustomerCreateParams.TaxInfo taxInfo) {
    ...
    public static class Address {
        ...
        public static class Builder {
            ...
            public CustomerCreateParams.Address.Builder setCountry(
                String country) {
             ...
             */
            public CustomerCreateParams.Address.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public CustomerCreateParams.Address.Builder putAllExtraParam(
                Map<String, Object> map) {
            ...
            public CustomerCreateParams.Address.Builder setPostalCode(
                String postalCode) {
    ...
    public static class InvoiceSettings {
        ...
        public static class Builder {
             ...
             */
            public CustomerCreateParams.InvoiceSettings.Builder putExtraParam(
                String key,
                Object value) {
             ...
             * Default footer to be displayed on invoices for this customer.
             */
            public CustomerCreateParams.InvoiceSettings.Builder setFooter(
                String footer) {
        ...
        public static class CustomField {
            ...
            public static class Builder {
                 ...
                 * The name of the custom field. This may be up to 30 characters.
                 */
                public CustomerCreateParams.InvoiceSettings.CustomField.Builder setName(
                    String name) {
                 ...
                 * The value of the custom field. This may be up to 30 characters.
                 */
                public CustomerCreateParams.InvoiceSettings.CustomField.Builder setValue(
                    String value) {
    ...
    public static class Shipping {
        ...
        public static class Builder {
             ...
             */
            public CustomerCreateParams.Shipping.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public CustomerCreateParams.Shipping.Builder putAllExtraParam(
                Map<String, Object> map) {
             ...
             * Customer phone (including extension).
             */
            public CustomerCreateParams.Shipping.Builder setPhone(
                String phone) {
        ...
        public static class Address {
            ...
            public static class Builder {
                ...
                public CustomerCreateParams.Shipping.Address.Builder setCity(
                    String city) {

                    this.city = city;
                    return this;
                }
                public CustomerCreateParams.Shipping.Address.Builder setCountry(
                    String country) {
                ...
                public CustomerCreateParams.Shipping.Address.Builder setLine1(
                    String line1) {

                    this.line1 = line1;
                    return this;
                }
                public CustomerCreateParams.Shipping.Address.Builder setLine2(
                    String line2) {

                    this.line2 = line2;
                    return this;
                }
                public CustomerCreateParams.Shipping.Address.Builder setPostalCode(
                    String postalCode) {

                    this.postalCode = postalCode;
                    return this;
                }
                public CustomerCreateParams.Shipping.Address.Builder setState(
                    String state) {
    ...
    public static class TaxIdData {
        ...
        public static class Builder {
            ...
            public CustomerCreateParams.TaxIdData build() {
                return new CustomerCreateParams.TaxIdData(
                    this.extraParams,
                    this.type,
                    this.value
                );
             ...
             */
            public CustomerCreateParams.TaxIdData.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public CustomerCreateParams.TaxIdData.Builder putAllExtraParam(
                Map<String, Object> map) {
             ...
             * Value of the tax ID.
             */
            public CustomerCreateParams.TaxIdData.Builder setValue(
                String value) {
    ...
    public static class TaxInfo {
        ...
        public static class Builder {
            ...
            public CustomerCreateParams.TaxInfo build() {
                return new CustomerCreateParams.TaxInfo(
                    this.extraParams,
                    this.taxId,
                    this.type
                );
             ...
             */
            public CustomerCreateParams.TaxInfo.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public CustomerCreateParams.TaxInfo.Builder putAllExtraParam(
                Map<String, Object> map) {
             ...
             * The type of ID number. The only possible value is `vat`
             */
            public CustomerCreateParams.TaxInfo.Builder setType(
                CustomerCreateParams.TaxInfo.Type type) {
