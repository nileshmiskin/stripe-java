...
public class SubscriptionScheduleCancelParams extends ApiRequestParams {
    ...
    public static class Builder {
         ...
         */
        public SubscriptionScheduleCancelParams.Builder addExpand(
            String element) {
         ...
         */
        public SubscriptionScheduleCancelParams.Builder addAllExpand(
            List<String> list) {
         ...
         */
        public SubscriptionScheduleCancelParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public SubscriptionScheduleCancelParams.Builder putAllExtraParam(
         ...
         * If the subscription schedule is `active`, indicates whether or not to generate a final invoice that contains any un-invoiced metered usage and new/pending proration invoice items. Defaults to `true`.
         */
        public SubscriptionScheduleCancelParams.Builder setInvoiceNow(
            Boolean invoiceNow) {
         ...
         * If the subscription schedule is `active`, indicates if the cancellation should be prorated. Defaults to `true`.
         */
        public SubscriptionScheduleCancelParams.Builder setProrate(
            Boolean prorate) {
