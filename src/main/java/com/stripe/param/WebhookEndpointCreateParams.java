...
public class WebhookEndpointCreateParams extends ApiRequestParams {
    ...
    WebhookEndpointCreateParams.ApiVersion apiVersion;
    ...
    public static WebhookEndpointCreateParams.Builder builder() {
        return new WebhookEndpointCreateParams.Builder();
    }
    public static class Builder {
        private WebhookEndpointCreateParams.ApiVersion apiVersion;
         ...
         * Events sent to this endpoint will be generated with this Stripe Version instead of your account's default Stripe Version.
         */
        public WebhookEndpointCreateParams.Builder setApiVersion(
            WebhookEndpointCreateParams.ApiVersion apiVersion) {
         ...
         */
        public WebhookEndpointCreateParams.Builder addEnabledEvent(
            WebhookEndpointCreateParams.EnabledEvent element) {
         ...
         */
        public WebhookEndpointCreateParams.Builder addAllEnabledEvent(
            List<WebhookEndpointCreateParams.EnabledEvent> list) {
         ...
         */
        public WebhookEndpointCreateParams.Builder addAllExpand(
            List<String> list) {
         ...
         */
        public WebhookEndpointCreateParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public WebhookEndpointCreateParams.Builder putAllExtraParam(
         ...
         * The URL of the webhook endpoint.
         */
        public WebhookEndpointCreateParams.Builder setUrl(String url) {
            this.url = url;
            return this;
        }
