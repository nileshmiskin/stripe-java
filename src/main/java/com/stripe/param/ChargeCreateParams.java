...
public class ChargeCreateParams extends ApiRequestParams {
    ...
    ChargeCreateParams.Destination destination;
    ...
    ChargeCreateParams.Shipping shipping;
    ...
    ChargeCreateParams.TransferData transferData;
    ...
    public static class Builder {
        ...
        private ChargeCreateParams.Destination destination;
        private List<String> expand;
        private Map<String, Object> extraParams;
        private Map<String, String> metadata;
        private String onBehalfOf;
        private String receiptEmail;
        private ChargeCreateParams.Shipping shipping;
        private String source;
        private String statementDescriptor;
        private ChargeCreateParams.TransferData transferData;
        ...
        public ChargeCreateParams.Builder setApplicationFee(
            Long applicationFee) {
         ...
         * A fee in %s that will be applied to the charge and transferred to the application owner's Stripe account. The request must be made with an OAuth key or the `Stripe-Account` header in order to take an application fee. For more information, see the application fees [documentation](https://stripe.com/docs/connect/direct-charges#collecting-fees).
         */
        public ChargeCreateParams.Builder setApplicationFeeAmount(
            Long applicationFeeAmount) {
        ...
        public ChargeCreateParams.Builder setDestination(
            ChargeCreateParams.Destination destination) {
         ...
         */
        public ChargeCreateParams.Builder addAllExpand(List<String> list) {
            if (this.expand == null) {
                this.expand = new ArrayList<>();
            }
         ...
         */
        public ChargeCreateParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public ChargeCreateParams.Builder putAllExtraParam(
         ...
         */
        public ChargeCreateParams.Builder putMetadata(
            String key,
            String value) {
         ...
         */
        public ChargeCreateParams.Builder putAllMetadata(
         ...
         * Shipping information for the charge. Helps prevent fraud on charges for physical goods.
         */
        public ChargeCreateParams.Builder setShipping(
            ChargeCreateParams.Shipping shipping) {
         ...
         * An arbitrary string to be used as the dynamic portion of the full descriptor displayed on your customer's credit card statement. This value will be prefixed by your [account's statement descriptor](https://stripe.com/docs/charges#dynamic-statement-descriptor). As an example, if your account's statement descriptor is `RUNCLUB` and the item you're charging for is a race ticket, you may want to specify a `statement_descriptor` of `5K RACE`, so that the resulting full descriptor would be `RUNCLUB* 5K RACE`. The full descriptor may be up to *22 characters*. This value must contain at least one letter, may not include `"'` characters, and will appear on your customer's statement in capital letters. Non-ASCII characters are automatically stripped. While most banks display this information consistently, some may display it incorrectly or not at all.
         */
        public ChargeCreateParams.Builder setStatementDescriptor(
            String statementDescriptor) {
         ...
         * An optional dictionary including the account to automatically transfer to as part of a destination charge. [See the Connect documentation](https://stripe.com/docs/connect/destination-charges) for details.
         */
        public ChargeCreateParams.Builder setTransferData(
            ChargeCreateParams.TransferData transferData) {
         ...
         * A string that identifies this transaction as part of a group. For details, see [Grouping transactions](https://stripe.com/docs/connect/charges-transfers#grouping-transactions).
         */
        public ChargeCreateParams.Builder setTransferGroup(
            String transferGroup) {
    ...
    public static class Destination {
        ...
        public static ChargeCreateParams.Destination.Builder builder() {
            return new ChargeCreateParams.Destination.Builder();
        }
        public static class Builder {
            ...
            public ChargeCreateParams.Destination build() {
                return new ChargeCreateParams.Destination(
                    this.account,
                    this.amount,
                    this.extraParams
                );
             ...
             * ID of an existing, connected Stripe account.
             */
            public ChargeCreateParams.Destination.Builder setAccount(
                String account) {
             ...
             * The amount to transfer to the destination account without creating an `Application Fee` object. Cannot be combined with the `application_fee` parameter. Must be less than or equal to the charge amount.
             */
            public ChargeCreateParams.Destination.Builder setAmount(
                Long amount) {
             ...
             */
            public ChargeCreateParams.Destination.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public ChargeCreateParams.Destination.Builder putAllExtraParam(
                Map<String, Object> map) {
    ...
    public static class Shipping {
        ...
        ChargeCreateParams.Shipping.Address address;
        ...
        public static ChargeCreateParams.Shipping.Builder builder() {
            return new ChargeCreateParams.Shipping.Builder();
        }
        public static class Builder {
            private ChargeCreateParams.Shipping.Address address;
             ...
             * Shipping address.
             */
            public ChargeCreateParams.Shipping.Builder setAddress(
                ChargeCreateParams.Shipping.Address address) {
             ...
             * The delivery service that shipped a physical product, such as Fedex, UPS, USPS, etc.
             */
            public ChargeCreateParams.Shipping.Builder setCarrier(
                String carrier) {
             ...
             */
            public ChargeCreateParams.Shipping.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public ChargeCreateParams.Shipping.Builder putAllExtraParam(
                Map<String, Object> map) {
             ...
             * Recipient name.
             */
            public ChargeCreateParams.Shipping.Builder setName(String name) {
                this.name = name;
                return this;
            }
             ...
             * Recipient phone (including extension).
             */
            public ChargeCreateParams.Shipping.Builder setPhone(String phone) {
                this.phone = phone;
                return this;
            }
             ...
             * The tracking number for a physical product, obtained from the delivery service. If multiple tracking numbers were generated for this purchase, please separate them with commas.
             */
            public ChargeCreateParams.Shipping.Builder setTrackingNumber(
                String trackingNumber) {
        ...
        public static class Address {
            ...
            public static ChargeCreateParams.Shipping.Address.Builder builder()
                {

                return new ChargeCreateParams.Shipping.Address.Builder();
            }
            public static class Builder {
                private String city;
                ...
                public ChargeCreateParams.Shipping.Address.Builder setCity(
                    String city) {

                    this.city = city;
                    return this;
                }
                public ChargeCreateParams.Shipping.Address.Builder setCountry(
                    String country) {
                 ...
                 */
                public ChargeCreateParams.Shipping.Address.Builder putExtraParam(
                    String key,
                    Object value) {
                 ...
                 */
                public ChargeCreateParams.Shipping.Address.Builder putAllExtraParam(
                    Map<String, Object> map) {
                ...
                public ChargeCreateParams.Shipping.Address.Builder setLine1(
                    String line1) {

                    this.line1 = line1;
                    return this;
                }
                public ChargeCreateParams.Shipping.Address.Builder setLine2(
                    String line2) {

                    this.line2 = line2;
                    return this;
                }
                public ChargeCreateParams.Shipping.Address.Builder setPostalCode(
                    String postalCode) {

                    this.postalCode = postalCode;
                    return this;
                }
                public ChargeCreateParams.Shipping.Address.Builder setState(
                    String state) {
    ...
    public static class TransferData {
        ...
        public static ChargeCreateParams.TransferData.Builder builder() {
            return new ChargeCreateParams.TransferData.Builder();
        }
        public static class Builder {
            private Long amount;
             ...
             * The amount transferred to the destination account, if specified. By default, the entire charge amount is transferred to the destination account.
             */
            public ChargeCreateParams.TransferData.Builder setAmount(
                Long amount) {
             ...
             * ID of an existing, connected Stripe account.
             */
            public ChargeCreateParams.TransferData.Builder setDestination(
                String destination) {
             ...
             */
            public ChargeCreateParams.TransferData.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public ChargeCreateParams.TransferData.Builder putAllExtraParam(
                Map<String, Object> map) {
