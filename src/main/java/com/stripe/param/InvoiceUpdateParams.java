...
public class InvoiceUpdateParams extends ApiRequestParams {
    ...
    public static class Builder {
         ...
         * A fee in %s that will be applied to the invoice and transferred to the application owner's Stripe account. The request must be made with an OAuth key or the Stripe-Account header in order to take an application fee. For more information, see the application fees [documentation](https://stripe.com/docs/connect/subscriptions#invoices).
         */
        public InvoiceUpdateParams.Builder setApplicationFeeAmount(
            Long applicationFeeAmount) {
         ...
         * ID of the default payment method for the invoice. It must belong to the customer associated with the invoice. If not set, defaults to the subscription's default payment method, if any, or to the default payment method in the customer's invoice settings.
         */
        public InvoiceUpdateParams.Builder setDefaultPaymentMethod(
            String defaultPaymentMethod) {
         ...
         * ID of the default payment source for the invoice. It must belong to the customer associated with the invoice and be in a chargeable state. If not set, defaults to the subscription's default source, if any, or to the customer's default source.
         */
        public InvoiceUpdateParams.Builder setDefaultSource(
            String defaultSource) {
         ...
         * The tax rates that will apply to any line item that does not have `tax_rates` set. Pass an empty string to remove previously-set default tax rates.
         */
        public InvoiceUpdateParams.Builder setDefaultTaxRates(
         ...
         */
        public InvoiceUpdateParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public InvoiceUpdateParams.Builder putAllExtraParam(
        ...
        public InvoiceUpdateParams.Builder putMetadata(
            String key,
            String value) {
        ...
        public InvoiceUpdateParams.Builder putAllMetadata(
         ...
         * Extra information about a charge for the customer's credit card statement. It must contain at least one letter. If not specified and this invoice is part of a subscription, the default `statement_descriptor` will be set to the first subscription item's product's `statement_descriptor`.
         */
        public InvoiceUpdateParams.Builder setStatementDescriptor(
            String statementDescriptor) {
         ...
         * The percent tax rate applied to the invoice, represented as a non-negative decimal number (with at most four decimal places) between 0 and 100. To unset a previously-set value, pass an empty string. This field can be updated only on `draft` invoices. This field has been deprecated and will be removed in a future API version, for further information view the [migration docs](https://stripe.com/docs/billing/migration/taxes) for `tax_rates`.
         */
        public InvoiceUpdateParams.Builder setTaxPercent(
    ...
    public static class CustomField {
        ...
        public static class Builder {
            ...
            public InvoiceUpdateParams.CustomField build() {
                return new InvoiceUpdateParams.CustomField(
                    this.extraParams,
                    this.name,
                    this.value
                );
             ...
             */
            public InvoiceUpdateParams.CustomField.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public InvoiceUpdateParams.CustomField.Builder putAllExtraParam(
                Map<String, Object> map) {
             ...
             * The name of the custom field. This may be up to 30 characters.
             */
            public InvoiceUpdateParams.CustomField.Builder setName(
                String name) {
             ...
             * The value of the custom field. This may be up to 30 characters.
             */
            public InvoiceUpdateParams.CustomField.Builder setValue(
                String value) {
    ...
    public static class TransferData {
        ...
        public static class Builder {
             ...
             * ID of an existing, connected Stripe account.
             */
            public InvoiceUpdateParams.TransferData.Builder setDestination(
                String destination) {
             ...
             */
            public InvoiceUpdateParams.TransferData.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public InvoiceUpdateParams.TransferData.Builder putAllExtraParam(
                Map<String, Object> map) {
