...
public class BalanceTransactionListParams extends ApiRequestParams {
    ...
    public static class Builder {
        ...
        public BalanceTransactionListParams.Builder setCurrency(
            String currency) {
         ...
         * A cursor for use in pagination. `ending_before` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with `obj_bar`, your subsequent call can include `ending_before=obj_bar` in order to fetch the previous page of the list.
         */
        public BalanceTransactionListParams.Builder setEndingBefore(
            String endingBefore) {
         ...
         */
        public BalanceTransactionListParams.Builder addAllExpand(
            List<String> list) {
         ...
         */
        public BalanceTransactionListParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public BalanceTransactionListParams.Builder putAllExtraParam(
         ...
         * A cursor for use in pagination. `starting_after` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with `obj_foo`, your subsequent call can include `starting_after=obj_foo` in order to fetch the next page of the list.
         */
        public BalanceTransactionListParams.Builder setStartingAfter(
            String startingAfter) {
    ...
    public static class AvailableOn {
        ...
        public static class Builder {
             ...
             * Minimum value to filter by (exclusive).
             */
            public BalanceTransactionListParams.AvailableOn.Builder setGt(
                Long gt) {
             ...
             * Minimum value to filter by (inclusive).
             */
            public BalanceTransactionListParams.AvailableOn.Builder setGte(
                Long gte) {
             ...
             * Maximum value to filter by (exclusive).
             */
            public BalanceTransactionListParams.AvailableOn.Builder setLt(
                Long lt) {
             ...
             * Maximum value to filter by (inclusive).
             */
            public BalanceTransactionListParams.AvailableOn.Builder setLte(
                Long lte) {
    ...
    public static class Created {
        ...
        public static class Builder {
             ...
             */
            public BalanceTransactionListParams.Created.Builder putExtraParam(
                String key,
                Object value) {
             ...
             * Minimum value to filter by (inclusive).
             */
            public BalanceTransactionListParams.Created.Builder setGte(
                Long gte) {
             ...
             * Maximum value to filter by (inclusive).
             */
            public BalanceTransactionListParams.Created.Builder setLte(
                Long lte) {
