...
public class InvoiceUpcomingParams extends ApiRequestParams {
    ...
    public static class Builder {
         ...
         */
        public InvoiceUpcomingParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public InvoiceUpcomingParams.Builder putAllExtraParam(
         ...
         */
        public InvoiceUpcomingParams.Builder addInvoiceItem(
            InvoiceUpcomingParams.InvoiceItem element) {
         ...
         * The identifier of the subscription for which you'd like to retrieve the upcoming invoice. If not provided, but a `subscription_items` is provided, you will preview creating a subscription with those items. If neither `subscription` nor `subscription_items` is provided, you will retrieve the next upcoming invoice from among the customer's subscriptions.
         */
        public InvoiceUpcomingParams.Builder setSubscription(
            String subscription) {
        ...
        public InvoiceUpcomingParams.Builder setSubscriptionCancelNow(
            Boolean subscriptionCancelNow) {
         ...
         * If previewing an update to a subscription, this decides whether the preview will show the result of applying prorations or not. If set, one of `subscription_items` or `subscription`, and one of `subscription_items` or `subscription_trial_end` are required.
         */
        public InvoiceUpcomingParams.Builder setSubscriptionProrate(
            Boolean subscriptionProrate) {
    ...
    public static class InvoiceItem {
        ...
        public static class Builder {
             ...
             * The integer amount in **%s** of previewed invoice item.
             */
            public InvoiceUpcomingParams.InvoiceItem.Builder setAmount(
                Long amount) {
             ...
             * Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies). Only applicable to new invoice items.
             */
            public InvoiceUpcomingParams.InvoiceItem.Builder setCurrency(
                String currency) {
             ...
             * An arbitrary string which you can attach to the invoice item. The description is displayed in the invoice for easy tracking.
             */
            public InvoiceUpcomingParams.InvoiceItem.Builder setDescription(
                String description) {
             ...
             * Explicitly controls whether discounts apply to this invoice item. Defaults to true, except for negative invoice items.
             */
            public InvoiceUpcomingParams.InvoiceItem.Builder setDiscountable(
                Boolean discountable) {
             ...
             */
            public InvoiceUpcomingParams.InvoiceItem.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public InvoiceUpcomingParams.InvoiceItem.Builder putAllExtraParam(
                Map<String, Object> map) {
             ...
             * The ID of the invoice item to update in preview. If not specified, a new invoice item will be added to the preview of the upcoming invoice.
             */
            public InvoiceUpcomingParams.InvoiceItem.Builder setInvoiceitem(
                String invoiceitem) {
             ...
             */
            public InvoiceUpcomingParams.InvoiceItem.Builder putMetadata(
                String key,
                String value) {
             ...
             */
            public InvoiceUpcomingParams.InvoiceItem.Builder putAllMetadata(
             ...
             * Non-negative integer. The quantity of units for the invoice item.
             */
            public InvoiceUpcomingParams.InvoiceItem.Builder setQuantity(
                Long quantity) {

                this.quantity = quantity;
                return this;
            }
            public InvoiceUpcomingParams.InvoiceItem.Builder setTaxRates(
             ...
             * The integer unit amount in **%s** of the charge to be applied to the upcoming invoice. This unit_amount will be multiplied by the quantity to get the full amount. If you want to apply a credit to the customer's account, pass a negative unit_amount.
             */
            public InvoiceUpcomingParams.InvoiceItem.Builder setUnitAmount(
                Long unitAmount) {
        ...
        public static class Period {
            ...
            public static class Builder {
                 ...
                 * The end of the period, which must be greater than or equal to the start.
                 */
                public InvoiceUpcomingParams.InvoiceItem.Period.Builder setEnd(
                    Long end) {
                 ...
                 * The start of the period.
                 */
                public InvoiceUpcomingParams.InvoiceItem.Period.Builder setStart(
                    Long start) {
    ...
    public static class SubscriptionItem {
        ...
        public static class Builder {
             ...
             * Delete all usage for a given subscription item. Allowed only when `deleted` is set to `true` and the current plan's `usage_type` is `metered`.
             */
            public InvoiceUpcomingParams.SubscriptionItem.Builder setClearUsage(
                Boolean clearUsage) {
             ...
             * A flag that, if set to `true`, will delete the specified item.
             */
            public InvoiceUpcomingParams.SubscriptionItem.Builder setDeleted(
                Boolean deleted) {
             ...
             * Subscription item to update.
             */
            public InvoiceUpcomingParams.SubscriptionItem.Builder setId(
                String id) {
             ...
             */
            public InvoiceUpcomingParams.SubscriptionItem.Builder putMetadata(
                String key,
                String value) {
             ...
             * Plan ID for this item, as a string.
             */
            public InvoiceUpcomingParams.SubscriptionItem.Builder setPlan(
                String plan) {
             ...
             * Quantity for this item.
             */
            public InvoiceUpcomingParams.SubscriptionItem.Builder setQuantity(
                Long quantity) {
             ...
             * The tax rates which apply to this `subscription_item`. When set, the `default_tax_rates` on the subscription do not apply to this `subscription_item`.
             */
            public InvoiceUpcomingParams.SubscriptionItem.Builder setTaxRates(
                List<String> taxRates) {
