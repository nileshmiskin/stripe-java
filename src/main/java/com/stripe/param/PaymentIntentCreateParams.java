...
Change `capture_method` to manual if you wish to [separate authorization and capture](https://stripe.com/docs/payments/payment-intents/creating-payment-intents#separate-authorization-and-capture) for payment methods that support this.
    ...
    /**
     * Set to `true` to attempt to confirm this PaymentIntent immediately. This parameter defaults to `false`. If the payment method attached is a card, a return_url may be provided in case additional authentication is required.
     */
...
more information, see the PaymentIntents [use case for connected accounts](https://stripe.com/docs/payments/payment-intents/use-cases#connected-accounts).
         */
        public PaymentIntentCreateParams.Builder setApplicationFeeAmount(
            Long applicationFeeAmount) {
...
Learn more about the different [confirmation flows](https://stripe.com/docs/payments/payment-intents#one-time-payments).
         ...
         * An arbitrary string attached to the object. Often useful for displaying to users.
         */
        public PaymentIntentCreateParams.Builder setDescription(
            String description) {
        ...
        /**
         * Add an element to `expand` list. A list is initialized for the first `add/addAll` call, and subsequent calls adds additional elements to the original list. See {@link PaymentIntentCreateParams#expand} for the field documentation.
         */
        ...
        /**
         * Add all elements to `expand` list. A list is initialized for the first `add/addAll` call, and subsequent calls adds additional elements to the original list. See {@link PaymentIntentCreateParams#expand} for the field documentation.
         */
        public PaymentIntentCreateParams.Builder addAllExpand(
            List<String> list) {
        ...
        /**
         * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link PaymentIntentCreateParams#extraParams} for the field documentation.
         */
        public PaymentIntentCreateParams.Builder putExtraParam(
            String key,
            Object value) {
        ...
        /**
         * Add all map key/value pairs to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link PaymentIntentCreateParams#extraParams} for the field documentation.
         */
        public PaymentIntentCreateParams.Builder putAllExtraParam(
        ...
        /**
         * Add a key/value pair to `metadata` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link PaymentIntentCreateParams#metadata} for the field documentation.
         */
        public PaymentIntentCreateParams.Builder putMetadata(
            String key,
            String value) {
        ...
        /**
         * Add all map key/value pairs to `metadata` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link PaymentIntentCreateParams#metadata} for the field documentation.
         */
        public PaymentIntentCreateParams.Builder putAllMetadata(
         ...
         * The Stripe account ID for which these funds are intended. For details, see the PaymentIntents [use case for connected accounts](https://stripe.com/docs/payments/payment-intents/use-cases#connected-accounts).
         */
        public PaymentIntentCreateParams.Builder setOnBehalfOf(
            String onBehalfOf) {
         ...
         * ID of the payment method (a PaymentMethod, Card, BankAccount, or saved Source object) to attach to this PaymentIntent.
         */
        public PaymentIntentCreateParams.Builder setPaymentMethod(
            String paymentMethod) {
        ...
        /**
         * Add an element to `paymentMethodTypes` list. A list is initialized for the first `add/addAll` call, and subsequent calls adds additional elements to the original list. See {@link PaymentIntentCreateParams#paymentMethodTypes} for the field documentation.
         */
        public PaymentIntentCreateParams.Builder addPaymentMethodType(
            String element) {
        ...
        /**
         * Add all elements to `paymentMethodTypes` list. A list is initialized for the first `add/addAll` call, and subsequent calls adds additional elements to the original list. See {@link PaymentIntentCreateParams#paymentMethodTypes} for the field documentation.
         */
        public PaymentIntentCreateParams.Builder addAllPaymentMethodType(
            List<String> list) {
         ...
         * Email address that the receipt for the resulting payment will be sent to.
         */
        public PaymentIntentCreateParams.Builder setReceiptEmail(
            String receiptEmail) {
...
This param can only be used if `confirm=true`.
         */
        public PaymentIntentCreateParams.Builder setReturnUrl(
            String returnUrl) {
...
If the payment method is already saved to a customer, this does nothing. If this type of payment method cannot be saved to a customer, the request will error.
         */
        public PaymentIntentCreateParams.Builder setSavePaymentMethod(
            Boolean savePaymentMethod) {
         ...
         * Extra information about a PaymentIntent. This will appear on your customer's statement when this PaymentIntent succeeds in creating a charge.
         */
        public PaymentIntentCreateParams.Builder setStatementDescriptor(
            String statementDescriptor) {
...
For more information, see the PaymentIntents [use case for connected accounts](https://stripe.com/docs/payments/payment-intents/use-cases#connected-accounts).
         ...
         * A string that identifies the resulting payment as part of a group. See the PaymentIntents [use case for connected accounts](https://stripe.com/docs/payments/payment-intents/use-cases#connected-accounts) for details.
         */
        public PaymentIntentCreateParams.Builder setTransferGroup(
            String transferGroup) {
    ...
    public static class Shipping {
        ...
        public static class Builder {
             ...
             * The delivery service that shipped a physical product, such as Fedex, UPS, USPS, etc.
             */
            public PaymentIntentCreateParams.Shipping.Builder setCarrier(
                String carrier) {
            ...
            /**
             * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link PaymentIntentCreateParams.Shipping#extraParams} for the field documentation.
             */
            public PaymentIntentCreateParams.Shipping.Builder putExtraParam(
                String key,
                Object value) {
            ...
            /**
             * Add all map key/value pairs to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link PaymentIntentCreateParams.Shipping#extraParams} for the field documentation.
             */
            public PaymentIntentCreateParams.Shipping.Builder putAllExtraParam(
                Map<String, Object> map) {
             ...
             * Recipient name.
             */
            public PaymentIntentCreateParams.Shipping.Builder setName(
                String name) {
             ...
             * Recipient phone (including extension).
             */
            public PaymentIntentCreateParams.Shipping.Builder setPhone(
                String phone) {
             ...
             * The tracking number for a physical product, obtained from the delivery service. If multiple tracking numbers were generated for this purchase, please separate them with commas.
             */
            public PaymentIntentCreateParams.Shipping.Builder setTrackingNumber(
                String trackingNumber) {
        ...
        public static class Address {
            ...
            public static class Builder {
                ...
                public PaymentIntentCreateParams.Shipping.Address.Builder setCity(
                    String city) {

                    this.city = city;
                    return this;
                }
                public PaymentIntentCreateParams.Shipping.Address.Builder setCountry(
                    String country) {
                ...
                /**
                 * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link PaymentIntentCreateParams.Shipping.Address#extraParams} for the field documentation.
                 */
                ...
                /**
                 * Add all map key/value pairs to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link PaymentIntentCreateParams.Shipping.Address#extraParams} for the field documentation.
                 */
                ...
                public PaymentIntentCreateParams.Shipping.Address.Builder setLine1(
                    String line1) {

                    this.line1 = line1;
                    return this;
                }
                public PaymentIntentCreateParams.Shipping.Address.Builder setLine2(
                    String line2) {

                    this.line2 = line2;
                    return this;
                }
                public PaymentIntentCreateParams.Shipping.Address.Builder setPostalCode(
                    String postalCode) {

                    this.postalCode = postalCode;
                    return this;
                }
                public PaymentIntentCreateParams.Shipping.Address.Builder setState(
                    String state) {
...
returned on the successful charge's `transfer` field.
             */
            public PaymentIntentCreateParams.TransferData.Builder setDestination(
                String destination) {
            ...
            /**
             * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link PaymentIntentCreateParams.TransferData#extraParams} for the field documentation.
             */
            ...
            /**
             * Add all map key/value pairs to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link PaymentIntentCreateParams.TransferData#extraParams} for the field documentation.
             */
