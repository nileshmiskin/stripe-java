...
public class PlanUpdateParams extends ApiRequestParams {
    ...
    public static class Builder {
         ...
         */
        public PlanUpdateParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public PlanUpdateParams.Builder putAllExtraParam(
         ...
         */
        public PlanUpdateParams.Builder putAllMetadata(
         ...
         * Default number of trial days when subscribing a customer to this plan using [`trial_from_plan=true`](https://stripe.com/docs/api#create_subscription-trial_from_plan).
         */
        public PlanUpdateParams.Builder setTrialPeriodDays(
            Long trialPeriodDays) {
