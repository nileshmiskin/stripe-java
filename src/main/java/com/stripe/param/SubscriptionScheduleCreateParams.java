...
public class SubscriptionScheduleCreateParams extends ApiRequestParams {
    ...
    public static class Builder {
         ...
         * The identifier of the customer to create the subscription schedule for.
         */
        public SubscriptionScheduleCreateParams.Builder setCustomer(
            String customer) {
        ...
        /**
         * Add an element to `expand` list. A list is initialized for the first `add/addAll` call, and subsequent calls adds additional elements to the original list. See {@link SubscriptionScheduleCreateParams#expand} for the field documentation.
         */
        public SubscriptionScheduleCreateParams.Builder addExpand(
            String element) {
        ...
        /**
         * Add all elements to `expand` list. A list is initialized for the first `add/addAll` call, and subsequent calls adds additional elements to the original list. See {@link SubscriptionScheduleCreateParams#expand} for the field documentation.
         */
        public SubscriptionScheduleCreateParams.Builder addAllExpand(
            List<String> list) {
        ...
        /**
         * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link SubscriptionScheduleCreateParams#extraParams} for the field documentation.
         */
        public SubscriptionScheduleCreateParams.Builder putExtraParam(
            String key,
            Object value) {
        ...
        /**
         * Add all map key/value pairs to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link SubscriptionScheduleCreateParams#extraParams} for the field documentation.
         */
        public SubscriptionScheduleCreateParams.Builder putAllExtraParam(
         ...
         * Migrate an existing subscription to be managed by a subscription schedule. If this parameter is set, a subscription schedule will be created using the subscription's plan(s), set to auto-renew using the subscription's interval. Other parameters cannot be set since their values will be inferred from the subscription.
         */
        public SubscriptionScheduleCreateParams.Builder setFromSubscription(
            String fromSubscription) {
        ...
        /**
         * Add a key/value pair to `metadata` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link SubscriptionScheduleCreateParams#metadata} for the field documentation.
         */
        public SubscriptionScheduleCreateParams.Builder putMetadata(
            String key,
            String value) {
        ...
        /**
         * Add all map key/value pairs to `metadata` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link SubscriptionScheduleCreateParams#metadata} for the field documentation.
         */
        public SubscriptionScheduleCreateParams.Builder putAllMetadata(
        ...
        /**
         * Add an element to `phases` list. A list is initialized for the first `add/addAll` call, and subsequent calls adds additional elements to the original list. See {@link SubscriptionScheduleCreateParams#phases} for the field documentation.
         */
    ...
    public static class BillingThresholds {
        ...
        public static class Builder {
            ...
            /**
             * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link SubscriptionScheduleCreateParams.BillingThresholds#extraParams} for the field documentation.
             */
            ...
            /**
             * Add all map key/value pairs to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link SubscriptionScheduleCreateParams.BillingThresholds#extraParams} for the field documentation.
             */
    ...
    public static class InvoiceSettings {
        ...
        public static class Builder {
            ...
            /**
             * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link SubscriptionScheduleCreateParams.InvoiceSettings#extraParams} for the field documentation.
             */
            ...
            /**
             * Add all map key/value pairs to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link SubscriptionScheduleCreateParams.InvoiceSettings#extraParams} for the field documentation.
             */
    ...
    public static class Phase {
        ...
        public static class Builder {
             ...
             * The identifier of the coupon to apply to this phase of the subscription schedule.
             */
            public SubscriptionScheduleCreateParams.Phase.Builder setCoupon(
                String coupon) {
             ...
             * The date at which this phase of the subscription schedule ends. If set, `iterations` must not be set.
             */
            public SubscriptionScheduleCreateParams.Phase.Builder setEndDate(
                Long endDate) {
            ...
            /**
             * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link SubscriptionScheduleCreateParams.Phase#extraParams} for the field documentation.
             */
            ...
            /**
             * Add all map key/value pairs to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link SubscriptionScheduleCreateParams.Phase#extraParams} for the field documentation.
             */
             ...
             * Integer representing the multiplier applied to the plan interval. For example, `iterations=2` applied to a plan with `interval=month` and `interval_count=3` results in a phase of duration `2 * 3 months = 6 months`. If set, `end_date` must not be set.
             */
            public SubscriptionScheduleCreateParams.Phase.Builder setIterations(
                Long iterations) {
            ...
            /**
             * Add an element to `plans` list. A list is initialized for the first `add/addAll` call, and subsequent calls adds additional elements to the original list. See {@link SubscriptionScheduleCreateParams.Phase#plans} for the field documentation.
             */
            ...
            /**
             * Add all elements to `plans` list. A list is initialized for the first `add/addAll` call, and subsequent calls adds additional elements to the original list. See {@link SubscriptionScheduleCreateParams.Phase#plans} for the field documentation.
             */
             ...
             * A non-negative decimal (with at most four decimal places) between 0 and 100. This represents the percentage of the subscription invoice subtotal that will be calculated and added as tax to the final amount in each billing period during thise phase of the schedule. For example, a plan which charges $10/month with a `tax_percent` of `20.0` will charge $12 per invoice. To unset a previously-set value, pass an empty string. This field has been deprecated and will be removed in a future API version, for further information view the [migration docs](https://stripe.com/docs/billing/migration/taxes) for `tax_rates`.
             */
            public SubscriptionScheduleCreateParams.Phase.Builder setTaxPercent(
                BigDecimal taxPercent) {
             ...
             * If set to true the entire phase is counted as a trial and the customer will not be charged for any fees.
             */
            public SubscriptionScheduleCreateParams.Phase.Builder setTrial(
                Boolean trial) {
             ...
             * Sets the phase to trialing from the start date to this date. Must be before the phase end date, can not be combined with `trial`
             */
            public SubscriptionScheduleCreateParams.Phase.Builder setTrialEnd(
                Long trialEnd) {
        ...
        public static class Plan {
            ...
            public static class Builder {
                ...
                /**
                 * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link SubscriptionScheduleCreateParams.Phase.Plan#extraParams} for the field documentation.
                 */
                ...
                /**
                 * Add all map key/value pairs to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link SubscriptionScheduleCreateParams.Phase.Plan#extraParams} for the field documentation.
                 */
                 ...
                 * The plan ID to subscribe to.
                 */
                public SubscriptionScheduleCreateParams.Phase.Plan.Builder setPlan(
                    String plan) {
                 ...
                 * Quantity for the given plan. Can be set only if the plan's `usage_type` is `licensed` and not `metered`.
                 */
                public SubscriptionScheduleCreateParams.Phase.Plan.Builder setQuantity(
                    Long quantity) {
            ...
            public static class BillingThresholds {
                ...
                public static SubscriptionScheduleCreateParams.Phase.Plan.BillingThresholds.Builder builder()
                    {
                ...
                public static class Builder {
                    ...
                    /**
                     * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link SubscriptionScheduleCreateParams.Phase.Plan.BillingThresholds#extraParams} for the field documentation.
                     */
                    public SubscriptionScheduleCreateParams.Phase.Plan.BillingThresholds.Builder putExtraParam(
                        String key,
                        Object value) {
                    ...
                    /**
                     * Add all map key/value pairs to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link SubscriptionScheduleCreateParams.Phase.Plan.BillingThresholds#extraParams} for the field documentation.
                     */
                    public SubscriptionScheduleCreateParams.Phase.Plan.BillingThresholds.Builder putAllExtraParam(
                        Map<String, Object> map) {
    ...
    public static class RenewalInterval {
        ...
        public static class Builder {
            ...
            /**
             * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link SubscriptionScheduleCreateParams.RenewalInterval#extraParams} for the field documentation.
             */
            ...
            /**
             * Add all map key/value pairs to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link SubscriptionScheduleCreateParams.RenewalInterval#extraParams} for the field documentation.
             */
             ...
             * Number of intervals to renew the subscription schedule for when it ends.
             */
            public SubscriptionScheduleCreateParams.RenewalInterval.Builder setLength(
                Long length) {
