...
public class SubscriptionScheduleReleaseParams extends ApiRequestParams {
    ...
    public static SubscriptionScheduleReleaseParams.Builder builder() {
        return new SubscriptionScheduleReleaseParams.Builder();
    }
    public static class Builder {
         ...
         */
        public SubscriptionScheduleReleaseParams.Builder addExpand(
            String element) {
         ...
         */
        public SubscriptionScheduleReleaseParams.Builder addAllExpand(
            List<String> list) {
         ...
         */
        public SubscriptionScheduleReleaseParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public SubscriptionScheduleReleaseParams.Builder putAllExtraParam(
         ...
         * Keep any cancellation on the subscription that the schedule has set.
         */
        public SubscriptionScheduleReleaseParams.Builder setPreserveCancelDate(
            Boolean preserveCancelDate) {
