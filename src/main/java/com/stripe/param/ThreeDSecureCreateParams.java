...
public class ThreeDSecureCreateParams extends ApiRequestParams {
    ...
    public static ThreeDSecureCreateParams.Builder builder() {
        return new ThreeDSecureCreateParams.Builder();
    }
    public static class Builder {
         ...
         * Amount of the charge that you will create when authentication completes.
         */
        public ThreeDSecureCreateParams.Builder setAmount(Long amount) {
            this.amount = amount;
            return this;
        }
         ...
         * The ID of a card token, or the ID of a card belonging to the given customer.
         */
        public ThreeDSecureCreateParams.Builder setCard(String card) {
            this.card = card;
            return this;
        }
         ...
         * Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies).
         */
        public ThreeDSecureCreateParams.Builder setCurrency(String currency) {
            this.currency = currency;
            return this;
        }
        public ThreeDSecureCreateParams.Builder setCustomer(String customer) {
            this.customer = customer;
            return this;
        }
         ...
         */
        public ThreeDSecureCreateParams.Builder addExpand(String element) {
            if (this.expand == null) {
         ...
         */
        public ThreeDSecureCreateParams.Builder addAllExpand(
            List<String> list) {
         ...
         */
        public ThreeDSecureCreateParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public ThreeDSecureCreateParams.Builder putAllExtraParam(
         ...
         * The URL that the cardholder's browser will be returned to when authentication completes.
         */
        public ThreeDSecureCreateParams.Builder setReturnUrl(String returnUrl) {
            this.returnUrl = returnUrl;
            return this;
        }
