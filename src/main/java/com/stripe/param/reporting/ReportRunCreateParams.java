...
public class ReportRunCreateParams extends ApiRequestParams {
    ...
    ReportRunCreateParams.Parameters parameters;
    ...
    public static ReportRunCreateParams.Builder builder() {
        return new ReportRunCreateParams.Builder();
    }
    public static class Builder {
        private List<String> expand;
        private Map<String, Object> extraParams;
        private ReportRunCreateParams.Parameters parameters;
         ...
         */
        public ReportRunCreateParams.Builder addExpand(String element) {
            if (this.expand == null) {
         ...
         */
        public ReportRunCreateParams.Builder addAllExpand(List<String> list) {
            if (this.expand == null) {
                this.expand = new ArrayList<>();
            }
         ...
         */
        public ReportRunCreateParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public ReportRunCreateParams.Builder putAllExtraParam(
         ...
         * Parameters specifying how the report should be run. Different Report Types have different required and optional parameters, listed in the [API Access to Reports](https://stripe.com/docs/reporting/statements/api) documentation.
         */
        public ReportRunCreateParams.Builder setParameters(
            ReportRunCreateParams.Parameters parameters) {
         ...
         * The ID of the [report type](https://stripe.com/docs/reporting/statements/api#report-types) to run, such as `"balance.summary.1"`.
         */
        public ReportRunCreateParams.Builder setReportType(String reportType) {
            this.reportType = reportType;
            return this;
        }
    ...
    public static class Parameters {
        ...
        public static ReportRunCreateParams.Parameters.Builder builder() {
            return new ReportRunCreateParams.Parameters.Builder();
        }
        public static class Builder {
            ...
            private ReportRunCreateParams.Parameters.ReportingCategory reportingCategory;
             ...
             */
            public ReportRunCreateParams.Parameters.Builder addColumn(
                String element) {
             ...
             */
            public ReportRunCreateParams.Parameters.Builder addAllColumn(
                List<String> list) {
             ...
             * Connected account ID to filter for in the report run.
             */
            public ReportRunCreateParams.Parameters.Builder setConnectedAccount(
                String connectedAccount) {
             ...
             * Currency of objects to be included in the report run.
             */
            public ReportRunCreateParams.Parameters.Builder setCurrency(
                String currency) {
             ...
             */
            public ReportRunCreateParams.Parameters.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public ReportRunCreateParams.Parameters.Builder putAllExtraParam(
                Map<String, Object> map) {
             ...
             * Ending timestamp of data to be included in the report run (exclusive).
             */
            public ReportRunCreateParams.Parameters.Builder setIntervalEnd(
                Long intervalEnd) {
             ...
             * Starting timestamp of data to be included in the report run.
             */
            public ReportRunCreateParams.Parameters.Builder setIntervalStart(
                Long intervalStart) {
             ...
             * Payout ID by which to filter the report run.
             */
            public ReportRunCreateParams.Parameters.Builder setPayout(
                String payout) {
             ...
             * Category of balance transactions to be included in the report run.
             */
            public ReportRunCreateParams.Parameters.Builder setReportingCategory(
                ReportRunCreateParams.Parameters.ReportingCategory reportingCategory) {
        ...
        public enum ReportingCategory implements ApiRequestParams.EnumParam {
            ...
            private ReportingCategory(String value) {
                this.value = value;
            }
