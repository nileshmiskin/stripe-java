...
public class RecipientListParams extends ApiRequestParams {
    ...
    public static RecipientListParams.Builder builder() {
        return new RecipientListParams.Builder();
    }
    public static class Builder {
        ...
        private RecipientListParams.Type type;
        ...
        public RecipientListParams.Builder setCreated(
            RecipientListParams.Created created) {

            this.created = created;
            return this;
        }
        public RecipientListParams.Builder setCreated(Long created) {
            this.created = created;
            return this;
        }
         ...
         * A cursor for use in pagination. `ending_before` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with `obj_bar`, your subsequent call can include `ending_before=obj_bar` in order to fetch the previous page of the list.
         */
        public RecipientListParams.Builder setEndingBefore(
            String endingBefore) {
         ...
         */
        public RecipientListParams.Builder addExpand(String element) {
            if (this.expand == null) {
         ...
         */
        public RecipientListParams.Builder addAllExpand(List<String> list) {
            if (this.expand == null) {
                this.expand = new ArrayList<>();
            }
         ...
         */
        public RecipientListParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public RecipientListParams.Builder putAllExtraParam(
         ...
         * A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
         */
        public RecipientListParams.Builder setLimit(Long limit) {
            this.limit = limit;
            return this;
        }
         ...
         * A cursor for use in pagination. `starting_after` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with `obj_foo`, your subsequent call can include `starting_after=obj_foo` in order to fetch the next page of the list.
         */
        public RecipientListParams.Builder setStartingAfter(
            String startingAfter) {

            this.startingAfter = startingAfter;
            return this;
        }
        public RecipientListParams.Builder setType(
            RecipientListParams.Type type) {
         ...
         * Only return recipients that are verified or unverified.
         */
        public RecipientListParams.Builder setVerified(Boolean verified) {
            this.verified = verified;
            return this;
        }
    ...
    public static class Created {
        ...
        public static RecipientListParams.Created.Builder builder() {
            return new RecipientListParams.Created.Builder();
        }
        public static class Builder {
            private Map<String, Object> extraParams;
            private Long gt;
            ...
            private Long lt;
            private Long lte;
            public RecipientListParams.Created build() {
                return new RecipientListParams.Created(
                    this.extraParams,
                    this.gt,
                    this.gte,
                    this.lt,
             ...
             */
            public RecipientListParams.Created.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public RecipientListParams.Created.Builder putAllExtraParam(
                Map<String, Object> map) {
             ...
             * Minimum value to filter by (exclusive).
             */
            public RecipientListParams.Created.Builder setGt(Long gt) {
                this.gt = gt;
                return this;
            }
             ...
             * Minimum value to filter by (inclusive).
             */
            public RecipientListParams.Created.Builder setGte(Long gte) {
                this.gte = gte;
                return this;
            }
             ...
             * Maximum value to filter by (exclusive).
             */
            public RecipientListParams.Created.Builder setLt(Long lt) {
                this.lt = lt;
                return this;
            }
             ...
             * Maximum value to filter by (inclusive).
             */
            public RecipientListParams.Created.Builder setLte(Long lte) {
                this.lte = lte;
                return this;
            }
