...
public class ProductUpdateParams extends ApiRequestParams {
    ...
    public static class Builder {
         ...
         * A list of up to 5 alphanumeric attributes that each SKU can provide values for (e.g., `["color", "size"]`). If a value for `attributes` is specified, the list specified will replace the existing attributes list on this product. Any attributes not present after the update will be deleted from the SKUs for this product.
         */
        public ProductUpdateParams.Builder setAttributes(
         ...
         */
        public ProductUpdateParams.Builder addAllDeactivateOn(
            List<String> list) {
         ...
         */
        public ProductUpdateParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public ProductUpdateParams.Builder putAllExtraParam(
         ...
         */
        public ProductUpdateParams.Builder putMetadata(
            String key,
            String value) {
         ...
         */
        public ProductUpdateParams.Builder putAllMetadata(
         ...
         * An arbitrary string to be displayed on your customer's credit card statement. This may be up to 22 characters. The statement description may not include "' characters, and will appear on your customer's statement in capital letters. Non-ASCII characters are automatically stripped. While most banks display this information consistently, some may display it incorrectly or not at all. It must contain at least one letter. May only be set if type=`service`.
         */
        public ProductUpdateParams.Builder setStatementDescriptor(
            String statementDescriptor) {
    ...
    public static class PackageDimensions {
        ...
        public static class Builder {
             ...
             */
            public ProductUpdateParams.PackageDimensions.Builder putExtraParam(
                String key,
                Object value) {
             ...
             * Height, in inches. Maximum precision is 2 decimal places.
             */
            public ProductUpdateParams.PackageDimensions.Builder setHeight(
                BigDecimal height) {
             ...
             * Length, in inches. Maximum precision is 2 decimal places.
             */
            public ProductUpdateParams.PackageDimensions.Builder setLength(
                BigDecimal length) {
             ...
             * Weight, in ounces. Maximum precision is 2 decimal places.
             */
            public ProductUpdateParams.PackageDimensions.Builder setWeight(
                BigDecimal weight) {
             ...
             * Width, in inches. Maximum precision is 2 decimal places.
             */
            public ProductUpdateParams.PackageDimensions.Builder setWidth(
                BigDecimal width) {
