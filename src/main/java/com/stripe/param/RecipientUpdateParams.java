...
public class RecipientUpdateParams extends ApiRequestParams {
    ...
    public static RecipientUpdateParams.Builder builder() {
        return new RecipientUpdateParams.Builder();
    }
    public static class Builder {
         ...
         * A bank account to attach to the recipient. You can provide either a token, like the ones returned by [Stripe.js](https://stripe.com/docs/stripe-js), or a dictionary containing a user's bank account details, with the options described below.
         */
        public RecipientUpdateParams.Builder setBankAccount(
            String bankAccount) {
         ...
         * ID of the card to set as the recipient's new default for payouts.
         */
        public RecipientUpdateParams.Builder setDefaultCard(
            String defaultCard) {
         ...
         * An arbitrary string which you can attach to a `Recipient` object. It is displayed alongside the recipient in the web interface.
         */
        public RecipientUpdateParams.Builder setDescription(
            String description) {
         ...
         */
        public RecipientUpdateParams.Builder addAllExpand(List<String> list) {
            if (this.expand == null) {
                this.expand = new ArrayList<>();
            }
         ...
         */
        public RecipientUpdateParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public RecipientUpdateParams.Builder putAllExtraParam(
         ...
         */
        public RecipientUpdateParams.Builder putMetadata(
            String key,
            String value) {
         ...
         */
        public RecipientUpdateParams.Builder putAllMetadata(
