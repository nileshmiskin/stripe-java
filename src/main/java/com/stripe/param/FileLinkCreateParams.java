...
public class FileLinkCreateParams extends ApiRequestParams {
    ...
    public static FileLinkCreateParams.Builder builder() {
        return new FileLinkCreateParams.Builder();
    }
    public static class Builder {
         ...
         */
        public FileLinkCreateParams.Builder addExpand(String element) {
            if (this.expand == null) {
         ...
         */
        public FileLinkCreateParams.Builder addAllExpand(List<String> list) {
            if (this.expand == null) {
                this.expand = new ArrayList<>();
            }
         ...
         * A future timestamp after which the link will no longer be usable.
         */
        public FileLinkCreateParams.Builder setExpiresAt(Long expiresAt) {
            this.expiresAt = expiresAt;
            return this;
        }
         ...
         */
        public FileLinkCreateParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public FileLinkCreateParams.Builder putAllExtraParam(
         ...
         * The ID of the file. The file's `purpose` must be one of the following: `business_icon`, `business_logo`, `customer_signature`, `dispute_evidence`, `finance_report_run`, `pci_document`, `sigma_scheduled_query`, or `tax_document_user_upload`.
         */
        public FileLinkCreateParams.Builder setFile(String file) {
            this.file = file;
            return this;
        }
         ...
         */
        public FileLinkCreateParams.Builder putMetadata(
            String key,
            String value) {
         ...
         */
        public FileLinkCreateParams.Builder putAllMetadata(
