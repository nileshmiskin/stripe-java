...
public class LoginLinkCreateOnAccountParams extends ApiRequestParams {
    ...
    public static LoginLinkCreateOnAccountParams.Builder builder() {
        return new LoginLinkCreateOnAccountParams.Builder();
    }
    public static class Builder {
        ...
        public LoginLinkCreateOnAccountParams build() {
            return new LoginLinkCreateOnAccountParams(
                this.expand,
                this.extraParams,
                this.redirectUrl
            );
         ...
         */
        public LoginLinkCreateOnAccountParams.Builder addExpand(
            String element) {
         ...
         */
        public LoginLinkCreateOnAccountParams.Builder addAllExpand(
            List<String> list) {
         ...
         */
        public LoginLinkCreateOnAccountParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public LoginLinkCreateOnAccountParams.Builder putAllExtraParam(
         ...
         * Where to redirect the user after they log out of their dashboard.
         */
        public LoginLinkCreateOnAccountParams.Builder setRedirectUrl(
            String redirectUrl) {
