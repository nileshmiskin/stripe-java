...
public class AccountPersonsParams extends ApiRequestParams {
    ...
    AccountPersonsParams.Relationship relationship;
    ...
    public static AccountPersonsParams.Builder builder() {
        return new AccountPersonsParams.Builder();
    }
    public static class Builder {
        ...
        private Long limit;
        private AccountPersonsParams.Relationship relationship;
         ...
         * A cursor for use in pagination. `ending_before` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with `obj_bar`, your subsequent call can include `ending_before=obj_bar` in order to fetch the previous page of the list.
         */
        public AccountPersonsParams.Builder setEndingBefore(
            String endingBefore) {
         ...
         */
        public AccountPersonsParams.Builder addExpand(String element) {
            if (this.expand == null) {
         ...
         */
        public AccountPersonsParams.Builder addAllExpand(List<String> list) {
            if (this.expand == null) {
                this.expand = new ArrayList<>();
            }
         ...
         */
        public AccountPersonsParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public AccountPersonsParams.Builder putAllExtraParam(
         ...
         * A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
         */
        public AccountPersonsParams.Builder setLimit(Long limit) {
            this.limit = limit;
            return this;
        }
         ...
         * Filters on the list of people returned based on the person's relationship to the account's company.
         */
        public AccountPersonsParams.Builder setRelationship(
            AccountPersonsParams.Relationship relationship) {
         ...
         * A cursor for use in pagination. `starting_after` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with `obj_foo`, your subsequent call can include `starting_after=obj_foo` in order to fetch the next page of the list.
         */
        public AccountPersonsParams.Builder setStartingAfter(
            String startingAfter) {
    ...
    public static class Relationship {
        ...
        public static AccountPersonsParams.Relationship.Builder builder() {
            return new AccountPersonsParams.Relationship.Builder();
        }
        public static class Builder {
             ...
             * A filter on the list of people returned based on whether these people are the account opener of the account's company.
             */
            public AccountPersonsParams.Relationship.Builder setAccountOpener(
                Boolean accountOpener) {
             ...
             * A filter on the list of people returned based on whether these people are directors of the account's company.
             */
            public AccountPersonsParams.Relationship.Builder setDirector(
                Boolean director) {
             ...
             */
            public AccountPersonsParams.Relationship.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public AccountPersonsParams.Relationship.Builder putAllExtraParam(
                Map<String, Object> map) {
             ...
             * A filter on the list of people returned based on whether these people are owners of the account's company.
             */
            public AccountPersonsParams.Relationship.Builder setOwner(
                Boolean owner) {
