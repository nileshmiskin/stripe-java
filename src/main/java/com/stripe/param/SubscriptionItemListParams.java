...
public class SubscriptionItemListParams extends ApiRequestParams {
    ...
    public static SubscriptionItemListParams.Builder builder() {
        return new SubscriptionItemListParams.Builder();
    }
    public static class Builder {
         ...
         * A cursor for use in pagination. `ending_before` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with `obj_bar`, your subsequent call can include `ending_before=obj_bar` in order to fetch the previous page of the list.
         */
        public SubscriptionItemListParams.Builder setEndingBefore(
            String endingBefore) {
         ...
         */
        public SubscriptionItemListParams.Builder addExpand(String element) {
            if (this.expand == null) {
         ...
         */
        public SubscriptionItemListParams.Builder addAllExpand(
            List<String> list) {
         ...
         */
        public SubscriptionItemListParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public SubscriptionItemListParams.Builder putAllExtraParam(
         ...
         * A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
         */
        public SubscriptionItemListParams.Builder setLimit(Long limit) {
            this.limit = limit;
            return this;
        }
         ...
         * A cursor for use in pagination. `starting_after` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with `obj_foo`, your subsequent call can include `starting_after=obj_foo` in order to fetch the next page of the list.
         */
        public SubscriptionItemListParams.Builder setStartingAfter(
            String startingAfter) {
         ...
         * The ID of the subscription whose items will be retrieved.
         */
        public SubscriptionItemListParams.Builder setSubscription(
            String subscription) {
