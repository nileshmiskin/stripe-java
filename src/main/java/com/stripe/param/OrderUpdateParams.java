...
public class OrderUpdateParams extends ApiRequestParams {
    ...
    public static class Builder {
         ...
         */
        public OrderUpdateParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public OrderUpdateParams.Builder putAllExtraParam(
         ...
         */
        public OrderUpdateParams.Builder putAllMetadata(
         ...
         * The shipping method to select for fulfilling this order. If specified, must be one of the `id`s of a shipping method in the `shipping_methods` array. If specified, will overwrite the existing selected shipping method, updating `items` as necessary.
         */
        public OrderUpdateParams.Builder setSelectedShippingMethod(
            String selectedShippingMethod) {
         ...
         * Tracking information once the order has been fulfilled.
         */
        public OrderUpdateParams.Builder setShipping(
            OrderUpdateParams.Shipping shipping) {
         ...
         * Current order status. One of `created`, `paid`, `canceled`, `fulfilled`, or `returned`. More detail in the [Orders Guide](https://stripe.com/docs/orders/guide#understanding-order-statuses).
         */
        public OrderUpdateParams.Builder setStatus(
            OrderUpdateParams.Status status) {
    ...
    public static class Shipping {
        ...
        public static class Builder {
            ...
            public OrderUpdateParams.Shipping build() {
                return new OrderUpdateParams.Shipping(
                    this.carrier,
                    this.extraParams,
                    this.trackingNumber
                );
             ...
             * The name of the carrier like `USPS`, `UPS`, or `FedEx`.
             */
            public OrderUpdateParams.Shipping.Builder setCarrier(
                String carrier) {
             ...
             */
            public OrderUpdateParams.Shipping.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public OrderUpdateParams.Shipping.Builder putAllExtraParam(
                Map<String, Object> map) {
             ...
             * The tracking number provided by the carrier.
             */
            public OrderUpdateParams.Shipping.Builder setTrackingNumber(
                String trackingNumber) {
