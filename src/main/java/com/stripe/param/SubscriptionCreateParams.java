...
public class SubscriptionCreateParams extends ApiRequestParams {
    ...
    public static class Builder {
         ...
         * For new subscriptions, a past timestamp to backdate the subscription's start date to. If set, the first invoice will contain a proration for the timespan between the start date and the current time. Can be combined with trials and the billing cycle anchor.
         */
        public SubscriptionCreateParams.Builder setBackdateStartDate(
            Long backdateStartDate) {
         ...
         * Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay this subscription at the end of the cycle using the default source attached to the customer. When sending an invoice, Stripe will email your customer an invoice with payment instructions. Defaults to `charge_automatically`.
         */
        public SubscriptionCreateParams.Builder setBilling(
            SubscriptionCreateParams.Billing billing) {
         ...
         * A future timestamp to anchor the subscription's [billing cycle](https://stripe.com/docs/subscriptions/billing-cycle). This is used to determine the date of the first full invoice, and, for plans with `month` or `year` intervals, the day of the month for subsequent invoices.
         */
        public SubscriptionCreateParams.Builder setBillingCycleAnchor(
            Long billingCycleAnchor) {
         ...
         * Boolean indicating whether this subscription should cancel at the end of the current period.
         */
        public SubscriptionCreateParams.Builder setCancelAtPeriodEnd(
            Boolean cancelAtPeriodEnd) {
         ...
         * Number of days a customer has to pay invoices generated by this subscription. Valid only for subscriptions where `billing` is set to `send_invoice`.
         */
        public SubscriptionCreateParams.Builder setDaysUntilDue(
            Long daysUntilDue) {
         ...
         * ID of the default payment method for the subscription. It must belong to the customer associated with the subscription. If not set, invoices will use the default payment method in the customer's invoice settings.
         */
        public SubscriptionCreateParams.Builder setDefaultPaymentMethod(
            String defaultPaymentMethod) {
         ...
         * ID of the default payment source for the subscription. It must belong to the customer associated with the subscription and be in a chargeable state. If not set, defaults to the customer's default source.
         */
        public SubscriptionCreateParams.Builder setDefaultSource(
            String defaultSource) {
         ...
         * The tax rates that will apply to any subscription item that does not have `tax_rates` set. Invoices created will have their `default_tax_rates` populated from the subscription.
         */
        public SubscriptionCreateParams.Builder setDefaultTaxRates(
         ...
         */
        public SubscriptionCreateParams.Builder addAllExpand(
            List<String> list) {
         ...
         */
        public SubscriptionCreateParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public SubscriptionCreateParams.Builder putAllExtraParam(
         ...
         */
        public SubscriptionCreateParams.Builder addItem(
            SubscriptionCreateParams.Item element) {
         ...
         */
        public SubscriptionCreateParams.Builder addAllItem(
            List<SubscriptionCreateParams.Item> list) {
         ...
         */
        public SubscriptionCreateParams.Builder putMetadata(
            String key,
            String value) {
         ...
         */
        public SubscriptionCreateParams.Builder putAllMetadata(
         ...
         * A non-negative decimal (with at most four decimal places) between 0 and 100. This represents the percentage of the subscription invoice subtotal that will be calculated and added as tax to the final amount in each billing period. For example, a plan which charges $10/month with a `tax_percent` of `20.0` will charge $12 per invoice. To unset a previously-set value, pass an empty string. This field has been deprecated and will be removed in a future API version, for further information view the [migration docs](https://stripe.com/docs/billing/migration/taxes) for `tax_rates`.
         */
        public SubscriptionCreateParams.Builder setTaxPercent(
         ...
         * Indicates if a plan's `trial_period_days` should be applied to the subscription. Setting `trial_end` per subscription is preferred, and this defaults to `false`. Setting this flag to `true` together with `trial_end` is not allowed.
         */
        public SubscriptionCreateParams.Builder setTrialFromPlan(
            Boolean trialFromPlan) {
         ...
         * Integer representing the number of trial period days before the customer is charged for the first time. This will always overwrite any trials that might apply via a subscribed plan.
         */
        public SubscriptionCreateParams.Builder setTrialPeriodDays(
            Long trialPeriodDays) {
    ...
    public static class BillingThresholds {
        ...
        public static class Builder {
             ...
             * Monetary threshold that triggers the subscription to advance to a new billing period.
             */
            public SubscriptionCreateParams.BillingThresholds.Builder setAmountGte(
                Long amountGte) {
    ...
    public static class Item {
        ...
        public static class Builder {
             ...
             */
            public SubscriptionCreateParams.Item.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public SubscriptionCreateParams.Item.Builder putAllExtraParam(
                Map<String, Object> map) {
             ...
             */
            public SubscriptionCreateParams.Item.Builder putMetadata(
                String key,
                String value) {
             ...
             */
            public SubscriptionCreateParams.Item.Builder putAllMetadata(
                Map<String, String> map) {
             ...
             * Quantity for this item.
             */
            public SubscriptionCreateParams.Item.Builder setQuantity(
                Long quantity) {
             ...
             * The tax rates which apply to this `subscription_item`. When set, the `default_tax_rates` on the subscription do not apply to this `subscription_item`.
             */
            public SubscriptionCreateParams.Item.Builder setTaxRates(
        ...
        public static class BillingThresholds {
            ...
            public static class Builder {
                 ...
                 * Usage threshold that triggers the subscription to advance to a new billing period.
                 */
                public SubscriptionCreateParams.Item.BillingThresholds.Builder setUsageGte(
                    Long usageGte) {
    ...
    public static class TransferData {
        ...
        public static class Builder {
             ...
             * ID of an existing, connected Stripe account.
             */
            public SubscriptionCreateParams.TransferData.Builder setDestination(
                String destination) {
             ...
             */
            public SubscriptionCreateParams.TransferData.Builder putExtraParam(
                String key,
                Object value) {
