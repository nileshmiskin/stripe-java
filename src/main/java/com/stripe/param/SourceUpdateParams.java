...
public class SourceUpdateParams extends ApiRequestParams {
    ...
    public static class Builder {
         ...
         */
        public SourceUpdateParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public SourceUpdateParams.Builder putAllExtraParam(
         ...
         */
        public SourceUpdateParams.Builder putMetadata(
            String key,
            String value) {
         ...
         */
        public SourceUpdateParams.Builder putAllMetadata(
         ...
         * Information about the owner of the payment instrument that may be used or required by particular source types.
         */
        public SourceUpdateParams.Builder setOwner(
            SourceUpdateParams.Owner owner) {
    ...
    public static class Owner {
        ...
        public static class Builder {
             ...
             * Owner's address.
             */
            public SourceUpdateParams.Owner.Builder setAddress(
                SourceUpdateParams.Owner.Address address) {
             ...
             */
            public SourceUpdateParams.Owner.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public SourceUpdateParams.Owner.Builder putAllExtraParam(
                Map<String, Object> map) {
        ...
        public static class Address {
            ...
            public static class Builder {
                ...
                public SourceUpdateParams.Owner.Address.Builder setCity(
                    String city) {

                    this.city = city;
                    return this;
                }
                public SourceUpdateParams.Owner.Address.Builder setCountry(
                    String country) {
                 ...
                 */
                public SourceUpdateParams.Owner.Address.Builder putExtraParam(
                    String key,
                    Object value) {
                 ...
                 */
                public SourceUpdateParams.Owner.Address.Builder putAllExtraParam(
                    Map<String, Object> map) {
                ...
                public SourceUpdateParams.Owner.Address.Builder setLine1(
                    String line1) {

                    this.line1 = line1;
                    return this;
                }
                public SourceUpdateParams.Owner.Address.Builder setLine2(
                    String line2) {

                    this.line2 = line2;
                    return this;
                }
                public SourceUpdateParams.Owner.Address.Builder setPostalCode(
                    String postalCode) {

                    this.postalCode = postalCode;
                    return this;
                }
                public SourceUpdateParams.Owner.Address.Builder setState(
                    String state) {
