...
public class BankAccountVerifyParams extends ApiRequestParams {
    ...
    public static BankAccountVerifyParams.Builder builder() {
        return new BankAccountVerifyParams.Builder();
    }
    public static class Builder {
        ...
        public BankAccountVerifyParams build() {
            return new BankAccountVerifyParams(
                this.amounts,
                this.expand,
                this.extraParams
            );
         ...
         */
        public BankAccountVerifyParams.Builder addAmount(Long element) {
         ...
         */
        public BankAccountVerifyParams.Builder addAllAmount(List<Long> list) {
            if (this.amounts == null) {
                this.amounts = new ArrayList<>();
            }
         ...
         */
        public BankAccountVerifyParams.Builder addExpand(String element) {
            if (this.expand == null) {
         ...
         */
        public BankAccountVerifyParams.Builder addAllExpand(List<String> list) {
            if (this.expand == null) {
                this.expand = new ArrayList<>();
            }
         ...
         */
        public BankAccountVerifyParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public BankAccountVerifyParams.Builder putAllExtraParam(
