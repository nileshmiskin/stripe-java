...
May only be used with line_items. Usage with subscription_data is not
yet available. If blank, Checkout will create a new customer object
based on information provided during the session. The email stored on
the customer will be used to prefill the email field on the Checkout
page. If the customer changes their email on the Checkout page, the
Customer object will be updated with the new email.
     */
...
one-time payments. To create subscriptions, use `subscription_data.items`.
     */
...
session with your internal systems.
         */
        public SessionCreateParams.Builder setClientReferenceId(
            String clientReferenceId) {
...
complete, use the `customer` field.
         */
        public SessionCreateParams.Builder setCustomerEmail(
            String customerEmail) {
         ...
         */
        public SessionCreateParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public SessionCreateParams.Builder putAllExtraParam(
         ...
         */
        public SessionCreateParams.Builder addLineItem(
            SessionCreateParams.LineItem element) {
         ...
         */
        public SessionCreateParams.Builder addAllLineItem(
            List<SessionCreateParams.LineItem> list) {
         ...
         * The IETF language tag of the locale Checkout is displayed in. If blank or `auto`, the browser's locale is used. Supported values are `auto`, `da`, `de`, `en`, `es`, `fi`, `fr`, `it`, `ja`, `nb`, `nl`, `pl`, `pt`, `sv`, or `zh`.
         */
        public SessionCreateParams.Builder setLocale(
            SessionCreateParams.Locale locale) {
    ...
    public static class LineItem {
        ...
        public static class Builder {
             ...
             * Three-letter [ISO currency code](https://www.iso.org/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https://stripe.com/docs/currencies).
             */
            public SessionCreateParams.LineItem.Builder setCurrency(
                String currency) {
             ...
             * The description for the line item.
             */
            public SessionCreateParams.LineItem.Builder setDescription(
                String description) {
             ...
             */
            public SessionCreateParams.LineItem.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public SessionCreateParams.LineItem.Builder putAllExtraParam(
                Map<String, Object> map) {
             ...
             */
            public SessionCreateParams.LineItem.Builder addImage(
                String element) {
             ...
             */
            public SessionCreateParams.LineItem.Builder addAllImage(
                List<String> list) {
             ...
             * The quantity of the line item being purchased.
             */
            public SessionCreateParams.LineItem.Builder setQuantity(
                Long quantity) {
...
information, see the PaymentIntents [use case for connected accounts](https://stripe.com/docs/payments/payment-intents/use-cases#connected-accounts).
             ...
             * An arbitrary string attached to the object. Often useful for displaying to users.
             */
            public SessionCreateParams.PaymentIntentData.Builder setDescription(
                String description) {
             ...
             */
            public SessionCreateParams.PaymentIntentData.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public SessionCreateParams.PaymentIntentData.Builder putMetadata(
                String key,
                String value) {
             ...
             */
            public SessionCreateParams.PaymentIntentData.Builder putAllMetadata(
             ...
             * The Stripe account ID for which these funds are intended. For details, see the PaymentIntents [use case for connected accounts](https://stripe.com/docs/payments/payment-intents/use-cases#connected-accounts).
             */
            public SessionCreateParams.PaymentIntentData.Builder setOnBehalfOf(
                String onBehalfOf) {
             ...
             * Email address that the receipt for the resulting payment will be sent to.
             */
            public SessionCreateParams.PaymentIntentData.Builder setReceiptEmail(
                String receiptEmail) {
...
For more information, see the PaymentIntents [use case for connected accounts](https://stripe.com/docs/payments/payment-intents/use-cases#connected-accounts).
        ...
        public static class Shipping {
            ...
            public static class Builder {
                 ...
                 * The delivery service that shipped a physical product, such as Fedex, UPS, USPS, etc.
                 */
                public SessionCreateParams.PaymentIntentData.Shipping.Builder setCarrier(
                    String carrier) {
                 ...
                 * Recipient name.
                 */
                public SessionCreateParams.PaymentIntentData.Shipping.Builder setName(
                    String name) {
                 ...
                 * Recipient phone (including extension).
                 */
                public SessionCreateParams.PaymentIntentData.Shipping.Builder setPhone(
                    String phone) {
...
payments, use `line_items`.
        ...
        public static class Builder {
             ...
             */
            public SessionCreateParams.SubscriptionData.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public SessionCreateParams.SubscriptionData.Builder putMetadata(
                String key,
                String value) {
             ...
             */
            public SessionCreateParams.SubscriptionData.Builder putAllMetadata(
                Map<String, String> map) {
             ...
             * Unix timestamp representing the end of the trial period the customer will get before being charged for the first time. Has to be at least 48h in the future.
             */
            public SessionCreateParams.SubscriptionData.Builder setTrialEnd(
                Long trialEnd) {
             ...
             * Integer representing the number of trial period days before the customer is charged for the first time.Has to be at least 1.
             */
            public SessionCreateParams.SubscriptionData.Builder setTrialPeriodDays(
                Long trialPeriodDays) {
        ...
        public static class Item {
            ...
            public static class Builder {
                 ...
                 * Plan ID for this item.
                 */
                public SessionCreateParams.SubscriptionData.Item.Builder setPlan(
                    String plan) {
                 ...
                 * Quantity for this item.
                 */
                public SessionCreateParams.SubscriptionData.Item.Builder setQuantity(
                    Long quantity) {
