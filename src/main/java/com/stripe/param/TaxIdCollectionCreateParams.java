...
public class TaxIdCollectionCreateParams extends ApiRequestParams {
     ...
     */
    @SerializedName("type")
    TaxIdCollectionCreateParams.Type type;
    ...
    public static TaxIdCollectionCreateParams.Builder builder() {
        return new TaxIdCollectionCreateParams.Builder();
    }
    public static class Builder {
        private List<String> expand;
        private Map<String, Object> extraParams;
        private TaxIdCollectionCreateParams.Type type;
        private String value;
        public TaxIdCollectionCreateParams build() {
            return new TaxIdCollectionCreateParams(
                this.expand,
                this.extraParams,
                this.type,
                this.value
         ...
         */
        public TaxIdCollectionCreateParams.Builder addExpand(String element) {
            if (this.expand == null) {
         ...
         */
        public TaxIdCollectionCreateParams.Builder addAllExpand(
            List<String> list) {
         ...
         */
        public TaxIdCollectionCreateParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public TaxIdCollectionCreateParams.Builder putAllExtraParam(
         ...
         * Type of the tax ID, one of `au_abn`, `eu_vat`, `in_gst`, `no_vat`, or `nz_gst`.
         */
        public TaxIdCollectionCreateParams.Builder setType(
            TaxIdCollectionCreateParams.Type type) {
         ...
         * Value of the tax ID.
         */
        public TaxIdCollectionCreateParams.Builder setValue(String value) {
            this.value = value;
            return this;
        }
