...
public class SkuListParams extends ApiRequestParams {
    ...
    public static SkuListParams.Builder builder() {
        return new SkuListParams.Builder();
    }
    public static class Builder {
         ...
         * Only return SKUs that are active or inactive (e.g., pass `false` to list all inactive products).
         */
        public SkuListParams.Builder setActive(Boolean active) {
            this.active = active;
            return this;
        }
         ...
         */
        public SkuListParams.Builder putAttribute(String key, String value) {
         ...
         */
        public SkuListParams.Builder putAllAttribute(Map<String, String> map) {
            if (this.attributes == null) {
                this.attributes = new HashMap<>();
            }
         ...
         * A cursor for use in pagination. `ending_before` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with `obj_bar`, your subsequent call can include `ending_before=obj_bar` in order to fetch the previous page of the list.
         */
        public SkuListParams.Builder setEndingBefore(String endingBefore) {
            this.endingBefore = endingBefore;
            return this;
        }
         ...
         */
        public SkuListParams.Builder addExpand(String element) {
            if (this.expand == null) {
         ...
         */
        public SkuListParams.Builder addAllExpand(List<String> list) {
            if (this.expand == null) {
                this.expand = new ArrayList<>();
            }
         ...
         */
        public SkuListParams.Builder putExtraParam(String key, Object value) {
         ...
         */
        public SkuListParams.Builder putAllExtraParam(Map<String, Object> map) {
            if (this.extraParams == null) {
                this.extraParams = new HashMap<>();
            }
         ...
         */
        public SkuListParams.Builder addId(String element) {
            if (this.ids == null) {
         ...
         */
        public SkuListParams.Builder addAllId(List<String> list) {
            if (this.ids == null) {
                this.ids = new ArrayList<>();
            }
         ...
         * Only return SKUs that are either in stock or out of stock (e.g., pass `false` to list all SKUs that are out of stock). If no value is provided, all SKUs are returned.
         */
        public SkuListParams.Builder setInStock(Boolean inStock) {
            this.inStock = inStock;
            return this;
        }
         ...
         * A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
         */
        public SkuListParams.Builder setLimit(Long limit) {
            this.limit = limit;
            return this;
        }
         ...
         * The ID of the product whose SKUs will be retrieved. Must be a product with type `good`.
         */
        public SkuListParams.Builder setProduct(String product) {
            this.product = product;
            return this;
        }
         ...
         * A cursor for use in pagination. `starting_after` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with `obj_foo`, your subsequent call can include `starting_after=obj_foo` in order to fetch the next page of the list.
         */
        public SkuListParams.Builder setStartingAfter(String startingAfter) {
            this.startingAfter = startingAfter;
            return this;
        }
