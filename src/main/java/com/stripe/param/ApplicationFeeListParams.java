...
public class ApplicationFeeListParams extends ApiRequestParams {
    ...
    private ApplicationFeeListParams(
        String charge,
        Object created,
        String endingBefore,
        List<String> expand,
    ...
    public static ApplicationFeeListParams.Builder builder() {
        return new ApplicationFeeListParams.Builder();
    }
    public static class Builder {
         ...
         * Only return application fees for the charge specified by this charge ID.
         */
        public ApplicationFeeListParams.Builder setCharge(String charge) {
            this.charge = charge;
            return this;
        }
        public ApplicationFeeListParams.Builder setCreated(
            ApplicationFeeListParams.Created created) {

            this.created = created;
            return this;
        }
        public ApplicationFeeListParams.Builder setCreated(Long created) {
            this.created = created;
            return this;
        }
         ...
         * A cursor for use in pagination. `ending_before` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with `obj_bar`, your subsequent call can include `ending_before=obj_bar` in order to fetch the previous page of the list.
         */
        public ApplicationFeeListParams.Builder setEndingBefore(
            String endingBefore) {
         ...
         */
        public ApplicationFeeListParams.Builder addExpand(String element) {
            if (this.expand == null) {
         ...
         */
        public ApplicationFeeListParams.Builder addAllExpand(
            List<String> list) {
         ...
         */
        public ApplicationFeeListParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public ApplicationFeeListParams.Builder putAllExtraParam(
         ...
         * A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
         */
        public ApplicationFeeListParams.Builder setLimit(Long limit) {
            this.limit = limit;
            return this;
        }
         ...
         * A cursor for use in pagination. `starting_after` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with `obj_foo`, your subsequent call can include `starting_after=obj_foo` in order to fetch the next page of the list.
         */
        public ApplicationFeeListParams.Builder setStartingAfter(
            String startingAfter) {
    ...
    public static class Created {
        ...
        public static ApplicationFeeListParams.Created.Builder builder() {
            return new ApplicationFeeListParams.Created.Builder();
        }
        public static class Builder {
            private Map<String, Object> extraParams;
            private Long gt;
             ...
             */
            public ApplicationFeeListParams.Created.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public ApplicationFeeListParams.Created.Builder putAllExtraParam(
                Map<String, Object> map) {
             ...
             * Minimum value to filter by (exclusive).
             */
            public ApplicationFeeListParams.Created.Builder setGt(Long gt) {
                this.gt = gt;
                return this;
            }
             ...
             * Minimum value to filter by (inclusive).
             */
            public ApplicationFeeListParams.Created.Builder setGte(Long gte) {
                this.gte = gte;
                return this;
            }
             ...
             * Maximum value to filter by (exclusive).
             */
            public ApplicationFeeListParams.Created.Builder setLt(Long lt) {
                this.lt = lt;
                return this;
            }
             ...
             * Maximum value to filter by (inclusive).
             */
            public ApplicationFeeListParams.Created.Builder setLte(Long lte) {
                this.lte = lte;
                return this;
            }
