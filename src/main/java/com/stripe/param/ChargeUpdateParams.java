...
public class ChargeUpdateParams extends ApiRequestParams {
    ...
    public static class Builder {
         ...
         */
        public ChargeUpdateParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public ChargeUpdateParams.Builder putAllExtraParam(
         ...
         */
        public ChargeUpdateParams.Builder putMetadata(
            String key,
            String value) {
         ...
         */
        public ChargeUpdateParams.Builder putAllMetadata(
         ...
         * Shipping information for the charge. Helps prevent fraud on charges for physical goods.
         */
        public ChargeUpdateParams.Builder setShipping(
            ChargeUpdateParams.Shipping shipping) {
         ...
         * A string that identifies this transaction as part of a group. `transfer_group` may only be provided if it has not been set. See the [Connect documentation](https://stripe.com/docs/connect/charges-transfers#grouping-transactions) for details.
         */
        public ChargeUpdateParams.Builder setTransferGroup(
            String transferGroup) {
    ...
    public static class FraudDetails {
        ...
        public static class Builder {
            ...
            public ChargeUpdateParams.FraudDetails build() {
                return new ChargeUpdateParams.FraudDetails(
                    this.extraParams,
                    this.userReport
                );
            }
             ...
             */
            public ChargeUpdateParams.FraudDetails.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public ChargeUpdateParams.FraudDetails.Builder putAllExtraParam(
                Map<String, Object> map) {
    ...
    public static class Shipping {
        ...
        public static class Builder {
             ...
             * The delivery service that shipped a physical product, such as Fedex, UPS, USPS, etc.
             */
            public ChargeUpdateParams.Shipping.Builder setCarrier(
                String carrier) {
             ...
             */
            public ChargeUpdateParams.Shipping.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public ChargeUpdateParams.Shipping.Builder putAllExtraParam(
                Map<String, Object> map) {
             ...
             * The tracking number for a physical product, obtained from the delivery service. If multiple tracking numbers were generated for this purchase, please separate them with commas.
             */
            public ChargeUpdateParams.Shipping.Builder setTrackingNumber(
                String trackingNumber) {
        ...
        public static class Address {
            ...
            public static class Builder {
                ...
                public ChargeUpdateParams.Shipping.Address.Builder setCity(
                    String city) {

                    this.city = city;
                    return this;
                }
                public ChargeUpdateParams.Shipping.Address.Builder setCountry(
                    String country) {
                 ...
                 */
                public ChargeUpdateParams.Shipping.Address.Builder putExtraParam(
                    String key,
                    Object value) {
                ...
                public ChargeUpdateParams.Shipping.Address.Builder setLine1(
                    String line1) {

                    this.line1 = line1;
                    return this;
                }
                public ChargeUpdateParams.Shipping.Address.Builder setLine2(
                    String line2) {

                    this.line2 = line2;
                    return this;
                }
                public ChargeUpdateParams.Shipping.Address.Builder setPostalCode(
                    String postalCode) {

                    this.postalCode = postalCode;
                    return this;
                }
                public ChargeUpdateParams.Shipping.Address.Builder setState(
                    String state) {
