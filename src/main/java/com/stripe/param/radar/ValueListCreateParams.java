...
public class ValueListCreateParams extends ApiRequestParams {
    ...
    ValueListCreateParams.ItemType itemType;
    ...
    public static ValueListCreateParams.Builder builder() {
        return new ValueListCreateParams.Builder();
    }
    public static class Builder {
        private String alias;
        private List<String> expand;
        private Map<String, Object> extraParams;
        private ValueListCreateParams.ItemType itemType;
         ...
         * The name of the value list for use in rules.
         */
        public ValueListCreateParams.Builder setAlias(String alias) {
            this.alias = alias;
            return this;
        }
         ...
         */
        public ValueListCreateParams.Builder addExpand(String element) {
            if (this.expand == null) {
         ...
         */
        public ValueListCreateParams.Builder addAllExpand(List<String> list) {
            if (this.expand == null) {
                this.expand = new ArrayList<>();
            }
         ...
         */
        public ValueListCreateParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public ValueListCreateParams.Builder putAllExtraParam(
         ...
         * Type of the items in the value list. One of `card_fingerprint`, `card_bin`, `email`, `ip_address`, `country`, `string`, or `case_sensitive_string`. Use `string` if the item type is unknown or mixed.
         */
        public ValueListCreateParams.Builder setItemType(
            ValueListCreateParams.ItemType itemType) {
         ...
         */
        public ValueListCreateParams.Builder putMetadata(
            String key,
            String value) {
         ...
         */
        public ValueListCreateParams.Builder putAllMetadata(
         ...
         * The human-readable name of the value list.
         */
        public ValueListCreateParams.Builder setName(String name) {
            this.name = name;
            return this;
        }
