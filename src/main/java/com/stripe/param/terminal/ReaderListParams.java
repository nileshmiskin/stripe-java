...
public class ReaderListParams extends ApiRequestParams {
    ...
    public static ReaderListParams.Builder builder() {
        return new ReaderListParams.Builder();
    }
    public static class Builder {
         ...
         * A cursor for use in pagination. `ending_before` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with `obj_bar`, your subsequent call can include `ending_before=obj_bar` in order to fetch the previous page of the list.
         */
        public ReaderListParams.Builder setEndingBefore(String endingBefore) {
            this.endingBefore = endingBefore;
            return this;
        }
         ...
         */
        public ReaderListParams.Builder addExpand(String element) {
            if (this.expand == null) {
         ...
         */
        public ReaderListParams.Builder addAllExpand(List<String> list) {
            if (this.expand == null) {
                this.expand = new ArrayList<>();
            }
         ...
         */
        public ReaderListParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public ReaderListParams.Builder putAllExtraParam(
         ...
         * A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
         */
        public ReaderListParams.Builder setLimit(Long limit) {
            this.limit = limit;
            return this;
        }
         ...
         * A location id to filter the response list to only readers at the specific location.
         */
        public ReaderListParams.Builder setLocation(String location) {
            this.location = location;
            return this;
        }
         ...
         * To [group objects](https://stripe.com/docs/terminal/payments/connect#grouping-objects-by-connected-account) on your platform account by connected account, set this parameter to the connected account ID.
         */
        public ReaderListParams.Builder setOperatorAccount(
            String operatorAccount) {
         ...
         * A cursor for use in pagination. `starting_after` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with `obj_foo`, your subsequent call can include `starting_after=obj_foo` in order to fetch the next page of the list.
         */
        public ReaderListParams.Builder setStartingAfter(String startingAfter) {
            this.startingAfter = startingAfter;
            return this;
        }
         ...
         * A status filter to filter readers to only offline or online readers.
         */
        public ReaderListParams.Builder setStatus(String status) {
            this.status = status;
            return this;
        }
