...
public class TaxRateUpdateParams extends ApiRequestParams {
    ...
    public static class Builder {
         ...
         */
        public TaxRateUpdateParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public TaxRateUpdateParams.Builder putAllExtraParam(
         ...
         * The jurisdiction for the tax rate.
         */
        public TaxRateUpdateParams.Builder setJurisdiction(
            String jurisdiction) {
         ...
         */
        public TaxRateUpdateParams.Builder putMetadata(
            String key,
            String value) {
         ...
         */
        public TaxRateUpdateParams.Builder putAllMetadata(
