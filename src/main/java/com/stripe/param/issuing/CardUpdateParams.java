...
public class CardUpdateParams extends ApiRequestParams {
    ...
    CardUpdateParams.AuthorizationControls authorizationControls;
    ...
    CardUpdateParams.Status status;
    ...
    public static CardUpdateParams.Builder builder() {
        return new CardUpdateParams.Builder();
    }
    public static class Builder {
        private CardUpdateParams.AuthorizationControls authorizationControls;
        private String cardholder;
        private List<String> expand;
        private Map<String, Object> extraParams;
        private Map<String, String> metadata;
        private CardUpdateParams.Status status;
         ...
         * Spending rules that give you some control over how your cards can be used. Refer to our [authorizations](https://stripe.com/docs/issuing/authorizations) documentation for more details.
         */
        public CardUpdateParams.Builder setAuthorizationControls(
            CardUpdateParams.AuthorizationControls authorizationControls) {
         ...
         * The [Cardholder](https://stripe.com/docs/api#issuing_cardholder_object) to associate the card with.
         */
        public CardUpdateParams.Builder setCardholder(String cardholder) {
            this.cardholder = cardholder;
            return this;
        }
         ...
         */
        public CardUpdateParams.Builder addAllExpand(List<String> list) {
            if (this.expand == null) {
                this.expand = new ArrayList<>();
            }
         ...
         */
        public CardUpdateParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public CardUpdateParams.Builder putAllExtraParam(
        ...
        public CardUpdateParams.Builder putAllMetadata(
         ...
         * Specifies whether to permit authorizations on this card. Possible values are `active`, `inactive`, or the terminal states: `canceled`, `lost`, `stolen`.
         */
        public CardUpdateParams.Builder setStatus(
            CardUpdateParams.Status status) {
    ...
    public static class AuthorizationControls {
        ...
        List<
            CardUpdateParams.AuthorizationControls.AllowedCategory
        > allowedCategories;
        ...
        List<
            CardUpdateParams.AuthorizationControls.BlockedCategory
        > blockedCategories;
        ...
        public static CardUpdateParams.AuthorizationControls.Builder builder() {
            return new CardUpdateParams.AuthorizationControls.Builder();
        }
        public static class Builder {
            private List<
                CardUpdateParams.AuthorizationControls.AllowedCategory
            ...
            private List<
                CardUpdateParams.AuthorizationControls.SpendingLimit
            > spendingLimits;
            public CardUpdateParams.AuthorizationControls build() {
                return new CardUpdateParams.AuthorizationControls(
             ...
             */
            public CardUpdateParams.AuthorizationControls.Builder addAllowedCategory(
                CardUpdateParams.AuthorizationControls.AllowedCategory element) {
             ...
             */
            public CardUpdateParams.AuthorizationControls.Builder addAllAllowedCategory(
                List<
                    CardUpdateParams.AuthorizationControls.AllowedCategory
                > list) {
             ...
             */
            public CardUpdateParams.AuthorizationControls.Builder addBlockedCategory(
                CardUpdateParams.AuthorizationControls.BlockedCategory element) {
             ...
             */
            public CardUpdateParams.AuthorizationControls.Builder addAllBlockedCategory(
                List<
                    CardUpdateParams.AuthorizationControls.BlockedCategory
                > list) {
             ...
             */
            public CardUpdateParams.AuthorizationControls.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public CardUpdateParams.AuthorizationControls.Builder putAllExtraParam(
                Map<String, Object> map) {
             ...
             * Maximum amount allowed per authorization on this card, in the currency of the card. Authorization amounts in a different currency will be converted to the card's currency when evaluating this control.
             */
            public CardUpdateParams.AuthorizationControls.Builder setMaxAmount(
                Long maxAmount) {
             ...
             * Maximum count of approved authorizations on this card. Counts all authorizations retroactively.
             */
            public CardUpdateParams.AuthorizationControls.Builder setMaxApprovals(
                Long maxApprovals) {
             ...
             */
            public CardUpdateParams.AuthorizationControls.Builder addSpendingLimit(
                CardUpdateParams.AuthorizationControls.SpendingLimit element) {
             ...
             */
            public CardUpdateParams.AuthorizationControls.Builder addAllSpendingLimit(
                List<
                    CardUpdateParams.AuthorizationControls.SpendingLimit
                > list) {
        ...
        public static class SpendingLimit {
            ...
            CardUpdateParams.AuthorizationControls.SpendingLimit.Interval interval;
            ...
            public static CardUpdateParams.AuthorizationControls.SpendingLimit.Builder builder()
                ...
                return new CardUpdateParams.AuthorizationControls.SpendingLimit.Builder(
            ...
            public static class Builder {
                ...
                > categories;
                private Map<String, Object> extraParams;
                private CardUpdateParams.AuthorizationControls.SpendingLimit.Interval interval;
                public CardUpdateParams.AuthorizationControls.SpendingLimit build()
                    {

                    return new CardUpdateParams.AuthorizationControls.SpendingLimit(
                        this.amount,
                        this.categories,
                        this.extraParams,
                        this.interval
                 ...
                 * Maximum amount allowed to spend per time interval.
                 */
                public CardUpdateParams.AuthorizationControls.SpendingLimit.Builder setAmount(
                    Long amount) {
                 ...
                 */
                public CardUpdateParams.AuthorizationControls.SpendingLimit.Builder addCategory(
                    CardUpdateParams.AuthorizationControls.SpendingLimit.Category element) {
                 ...
                 */
                public CardUpdateParams.AuthorizationControls.SpendingLimit.Builder addAllCategory(
                    List<
                        CardUpdateParams.AuthorizationControls.SpendingLimit.Category
                    > list) {
                 ...
                 */
                public CardUpdateParams.AuthorizationControls.SpendingLimit.Builder putExtraParam(
                    String key,
                    Object value) {
                 ...
                 */
                public CardUpdateParams.AuthorizationControls.SpendingLimit.Builder putAllExtraParam(
                    Map<String, Object> map) {
                 ...
                 * The time interval with which to apply this spending limit towards. Allowed values are 'per_authorization', 'daily', 'weekly', 'monthly', 'yearly', and 'all_time'.
                 */
                public CardUpdateParams.AuthorizationControls.SpendingLimit.Builder setInterval(
                    CardUpdateParams.AuthorizationControls.SpendingLimit.Interval interval) {
