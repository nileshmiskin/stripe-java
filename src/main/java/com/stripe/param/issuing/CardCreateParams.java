...
public class CardCreateParams extends ApiRequestParams {
    ...
    CardCreateParams.AuthorizationControls authorizationControls;
    ...
    CardCreateParams.ReplacementReason replacementReason;

    /**
     * The address where the card will be shipped.
     */
    @SerializedName("shipping")
    CardCreateParams.Shipping shipping;

    /**
     * Specifies whether to permit authorizations on this card. Possible values are `active` or `inactive`.
     */
    @SerializedName("status")
    CardCreateParams.Status status;

    /**
     * The type of card to issue. Possible values are `physical` or `virtual`.
     */
    @SerializedName("type")
    CardCreateParams.Type type;
    ...
    public static CardCreateParams.Builder builder() {
        return new CardCreateParams.Builder();
    }
    public static class Builder {
        private CardCreateParams.AuthorizationControls authorizationControls;
        ...
        private CardCreateParams.ReplacementReason replacementReason;
        private CardCreateParams.Shipping shipping;
        private CardCreateParams.Status status;
        private CardCreateParams.Type type;
         ...
         * Spending rules that give you some control over how your cards can be used. Refer to our [authorizations](https://stripe.com/docs/issuing/authorizations) documentation for more details.
         */
        public CardCreateParams.Builder setAuthorizationControls(
            CardCreateParams.AuthorizationControls authorizationControls) {
        ...
        /**
         * Add an element to `expand` list. A list is initialized for the first `add/addAll` call, and subsequent calls adds additional elements to the original list. See {@link CardCreateParams#expand} for the field documentation.
         */
        ...
        /**
         * Add all elements to `expand` list. A list is initialized for the first `add/addAll` call, and subsequent calls adds additional elements to the original list. See {@link CardCreateParams#expand} for the field documentation.
         */
        public CardCreateParams.Builder addAllExpand(List<String> list) {
            if (this.expand == null) {
                this.expand = new ArrayList<>();
            }
        ...
        /**
         * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link CardCreateParams#extraParams} for the field documentation.
         */
        public CardCreateParams.Builder putExtraParam(
            String key,
            Object value) {
        ...
        /**
         * Add all map key/value pairs to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link CardCreateParams#extraParams} for the field documentation.
         */
        public CardCreateParams.Builder putAllExtraParam(
        ...
        public CardCreateParams.Builder putAllMetadata(
         ...
         * The card this is meant to be a replacement for (if any).
         */
        public CardCreateParams.Builder setReplacementFor(
            String replacementFor) {
         ...
         * If `replacement_for` is specified, this should indicate why that card is being replaced. One of `damage`, `expiration`, `loss`, or `theft`.
         */
        public CardCreateParams.Builder setReplacementReason(
            CardCreateParams.ReplacementReason replacementReason) {
         ...
         * The address where the card will be shipped.
         */
        public CardCreateParams.Builder setShipping(
            CardCreateParams.Shipping shipping) {
         ...
         * Specifies whether to permit authorizations on this card. Possible values are `active` or `inactive`.
         */
        public CardCreateParams.Builder setStatus(
            CardCreateParams.Status status) {
    ...
    public static class AuthorizationControls {
        ...
        public static CardCreateParams.AuthorizationControls.Builder builder() {
            return new CardCreateParams.AuthorizationControls.Builder();
        }
        public static class Builder {
            private List<
                CardCreateParams.AuthorizationControls.AllowedCategory
            ...
            private List<
                CardCreateParams.AuthorizationControls.SpendingLimit
            > spendingLimits;
            public CardCreateParams.AuthorizationControls build() {
                return new CardCreateParams.AuthorizationControls(
            ...
            /**
             * Add an element to `allowedCategories` list. A list is initialized for the first `add/addAll` call, and subsequent calls adds additional elements to the original list. See {@link CardCreateParams.AuthorizationControls#allowedCategories} for the field documentation.
             */
            public CardCreateParams.AuthorizationControls.Builder addAllowedCategory(
                CardCreateParams.AuthorizationControls.AllowedCategory element) {
            ...
            /**
             * Add all elements to `allowedCategories` list. A list is initialized for the first `add/addAll` call, and subsequent calls adds additional elements to the original list. See {@link CardCreateParams.AuthorizationControls#allowedCategories} for the field documentation.
             */
            public CardCreateParams.AuthorizationControls.Builder addAllAllowedCategory(
                List<
                    CardCreateParams.AuthorizationControls.AllowedCategory
                > list) {
            ...
            /**
             * Add an element to `blockedCategories` list. A list is initialized for the first `add/addAll` call, and subsequent calls adds additional elements to the original list. See {@link CardCreateParams.AuthorizationControls#blockedCategories} for the field documentation.
             */
            public CardCreateParams.AuthorizationControls.Builder addBlockedCategory(
                CardCreateParams.AuthorizationControls.BlockedCategory element) {
            ...
            /**
             * Add all elements to `blockedCategories` list. A list is initialized for the first `add/addAll` call, and subsequent calls adds additional elements to the original list. See {@link CardCreateParams.AuthorizationControls#blockedCategories} for the field documentation.
             */
            public CardCreateParams.AuthorizationControls.Builder addAllBlockedCategory(
                List<
                    CardCreateParams.AuthorizationControls.BlockedCategory
                > list) {
            ...
            /**
             * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link CardCreateParams.AuthorizationControls#extraParams} for the field documentation.
             */
            public CardCreateParams.AuthorizationControls.Builder putExtraParam(
                String key,
                Object value) {
            ...
            /**
             * Add all map key/value pairs to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link CardCreateParams.AuthorizationControls#extraParams} for the field documentation.
             */
            public CardCreateParams.AuthorizationControls.Builder putAllExtraParam(
                Map<String, Object> map) {
             ...
             * Maximum amount allowed per authorization on this card, in the currency of the card. Authorization amounts in a different currency will be converted to the card's currency when evaluating this control.
             */
            public CardCreateParams.AuthorizationControls.Builder setMaxAmount(
                Long maxAmount) {
             ...
             * Maximum count of approved authorizations on this card. Counts all authorizations retroactively.
             */
            public CardCreateParams.AuthorizationControls.Builder setMaxApprovals(
                Long maxApprovals) {
            ...
            /**
             * Add an element to `spendingLimits` list. A list is initialized for the first `add/addAll` call, and subsequent calls adds additional elements to the original list. See {@link CardCreateParams.AuthorizationControls#spendingLimits} for the field documentation.
             */
            public CardCreateParams.AuthorizationControls.Builder addSpendingLimit(
                CardCreateParams.AuthorizationControls.SpendingLimit element) {
            ...
            /**
             * Add all elements to `spendingLimits` list. A list is initialized for the first `add/addAll` call, and subsequent calls adds additional elements to the original list. See {@link CardCreateParams.AuthorizationControls#spendingLimits} for the field documentation.
             */
            public CardCreateParams.AuthorizationControls.Builder addAllSpendingLimit(
                List<
                    CardCreateParams.AuthorizationControls.SpendingLimit
                > list) {
        ...
        public static class SpendingLimit {
            ...
            List<
                CardCreateParams.AuthorizationControls.SpendingLimit.Category
            > categories;
            ...
            CardCreateParams.AuthorizationControls.SpendingLimit.Interval interval;
            ...
            public static CardCreateParams.AuthorizationControls.SpendingLimit.Builder builder()
                {

                return new CardCreateParams.AuthorizationControls.SpendingLimit.Builder(
            ...
            public static class Builder {
                ...
                > categories;
                private Map<String, Object> extraParams;
                private CardCreateParams.AuthorizationControls.SpendingLimit.Interval interval;
                public CardCreateParams.AuthorizationControls.SpendingLimit build()
                    {

                    return new CardCreateParams.AuthorizationControls.SpendingLimit(
                        this.amount,
                        this.categories,
                        this.extraParams,
                        this.interval
                 ...
                 * Maximum amount allowed to spend per time interval.
                 */
                public CardCreateParams.AuthorizationControls.SpendingLimit.Builder setAmount(
                    Long amount) {
                ...
                /**
                 * Add an element to `categories` list. A list is initialized for the first `add/addAll` call, and subsequent calls adds additional elements to the original list. See {@link CardCreateParams.AuthorizationControls.SpendingLimit#categories} for the field documentation.
                 */
                public CardCreateParams.AuthorizationControls.SpendingLimit.Builder addCategory(
                    CardCreateParams.AuthorizationControls.SpendingLimit.Category element) {
                ...
                /**
                 * Add all elements to `categories` list. A list is initialized for the first `add/addAll` call, and subsequent calls adds additional elements to the original list. See {@link CardCreateParams.AuthorizationControls.SpendingLimit#categories} for the field documentation.
                 */
                public CardCreateParams.AuthorizationControls.SpendingLimit.Builder addAllCategory(
                    List<
                        CardCreateParams.AuthorizationControls.SpendingLimit.Category
                    > list) {
                ...
                /**
                 * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link CardCreateParams.AuthorizationControls.SpendingLimit#extraParams} for the field documentation.
                 */
                public CardCreateParams.AuthorizationControls.SpendingLimit.Builder putExtraParam(
                    String key,
                    Object value) {
                ...
                /**
                 * Add all map key/value pairs to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link CardCreateParams.AuthorizationControls.SpendingLimit#extraParams} for the field documentation.
                 */
                public CardCreateParams.AuthorizationControls.SpendingLimit.Builder putAllExtraParam(
                    Map<String, Object> map) {
                 ...
                 * The time interval with which to apply this spending limit towards. Allowed values are 'per_authorization', 'daily', 'weekly', 'monthly', 'yearly', and 'all_time'.
                 */
                public CardCreateParams.AuthorizationControls.SpendingLimit.Builder setInterval(
                    CardCreateParams.AuthorizationControls.SpendingLimit.Interval interval) {
    ...
    public static class Shipping {
        ...
        CardCreateParams.Shipping.Address address;
        ...
        public static CardCreateParams.Shipping.Builder builder() {
            return new CardCreateParams.Shipping.Builder();
        }
        public static class Builder {
            private CardCreateParams.Shipping.Address address;
            private Map<String, Object> extraParams;
            private String name;
            ...
            public CardCreateParams.Shipping.Builder setAddress(
                CardCreateParams.Shipping.Address address) {
            ...
            /**
             * Add a key/value pair to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link CardCreateParams.Shipping#extraParams} for the field documentation.
             */
            public CardCreateParams.Shipping.Builder putExtraParam(
                String key,
                Object value) {
            ...
            /**
             * Add all map key/value pairs to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link CardCreateParams.Shipping#extraParams} for the field documentation.
             */
            public CardCreateParams.Shipping.Builder putAllExtraParam(
                Map<String, Object> map) {
            ...
            public CardCreateParams.Shipping.Builder setName(String name) {
                this.name = name;
                return this;
            }
             ...
             * One of `bulk` or `individual`. Bulk shipments will be grouped and mailed together, while individual ones will not.
             */
            public CardCreateParams.Shipping.Builder setType(EmptyParam type) {
                this.type = type;
                return this;
            }
             ...
             * One of `bulk` or `individual`. Bulk shipments will be grouped and mailed together, while individual ones will not.
             */
            public CardCreateParams.Shipping.Builder setType(
                CardCreateParams.Shipping.Type type) {
        ...
        public static class Address {
            ...
            public static CardCreateParams.Shipping.Address.Builder builder() {
                return new CardCreateParams.Shipping.Address.Builder();
            }
            public static class Builder {
                private String city;
                ...
                public CardCreateParams.Shipping.Address.Builder setCity(
                    String city) {

                    this.city = city;
                    return this;
                }
                public CardCreateParams.Shipping.Address.Builder setCountry(
                    String country) {
                 ...
                 */
                public CardCreateParams.Shipping.Address.Builder putExtraParam(
                    String key,
                    Object value) {
                ...
                /**
                 * Add all map key/value pairs to `extraParams` map. A map is initialized for the first `put/putAll` call, and subsequent calls add additional key/value pairs to the original map. See {@link CardCreateParams.Shipping.Address#extraParams} for the field documentation.
                 */
                public CardCreateParams.Shipping.Address.Builder putAllExtraParam(
                    Map<String, Object> map) {
                ...
                public CardCreateParams.Shipping.Address.Builder setLine1(
                    String line1) {

                    this.line1 = line1;
                    return this;
                }
                public CardCreateParams.Shipping.Address.Builder setLine2(
                    String line2) {

                    this.line2 = line2;
                    return this;
                }
                public CardCreateParams.Shipping.Address.Builder setPostalCode(
                    String postalCode) {

                    this.postalCode = postalCode;
                    return this;
                }
                public CardCreateParams.Shipping.Address.Builder setState(
                    String state) {
    ...
    public enum ReplacementReason implements ApiRequestParams.EnumParam {
        ...
        @Getter(onMethod_ = {@Override})
        private final String value;
        private ReplacementReason(String value) {
            this.value = value;
        }
