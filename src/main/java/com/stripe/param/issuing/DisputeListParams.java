...
public class DisputeListParams extends ApiRequestParams {
    ...
    public static DisputeListParams.Builder builder() {
        return new DisputeListParams.Builder();
    }
    public static class Builder {
         ...
         * Only return issuing disputes that were created during the given date interval.
         */
        public DisputeListParams.Builder setCreated(
            DisputeListParams.Created created) {
         ...
         * Only return issuing disputes that were created during the given date interval.
         */
        public DisputeListParams.Builder setCreated(Long created) {
            this.created = created;
            return this;
        }
         ...
         * Only return issuing disputes for the given transaction.
         */
        public DisputeListParams.Builder setDisputedTransaction(
            String disputedTransaction) {
         ...
         * A cursor for use in pagination. `ending_before` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, starting with `obj_bar`, your subsequent call can include `ending_before=obj_bar` in order to fetch the previous page of the list.
         */
        public DisputeListParams.Builder setEndingBefore(String endingBefore) {
            this.endingBefore = endingBefore;
            return this;
        }
         ...
         */
        public DisputeListParams.Builder addExpand(String element) {
            if (this.expand == null) {
         ...
         */
        public DisputeListParams.Builder addAllExpand(List<String> list) {
            if (this.expand == null) {
                this.expand = new ArrayList<>();
            }
         ...
         */
        public DisputeListParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public DisputeListParams.Builder putAllExtraParam(
         ...
         * A limit on the number of objects to be returned. Limit can range between 1 and 100, and the default is 10.
         */
        public DisputeListParams.Builder setLimit(Long limit) {
            this.limit = limit;
            return this;
        }
         ...
         * A cursor for use in pagination. `starting_after` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with `obj_foo`, your subsequent call can include `starting_after=obj_foo` in order to fetch the next page of the list.
         */
        public DisputeListParams.Builder setStartingAfter(
            String startingAfter) {
    ...
    public static class Created {
        ...
        public static DisputeListParams.Created.Builder builder() {
            return new DisputeListParams.Created.Builder();
        }
        public static class Builder {
            private Map<String, Object> extraParams;
            private Long gt;
             ...
             */
            public DisputeListParams.Created.Builder putExtraParam(
                String key,
                Object value) {
             ...
             */
            public DisputeListParams.Created.Builder putAllExtraParam(
                Map<String, Object> map) {
             ...
             * Minimum value to filter by (exclusive).
             */
            public DisputeListParams.Created.Builder setGt(Long gt) {
                this.gt = gt;
                return this;
            }
             ...
             * Minimum value to filter by (inclusive).
             */
            public DisputeListParams.Created.Builder setGte(Long gte) {
                this.gte = gte;
                return this;
            }
             ...
             * Maximum value to filter by (exclusive).
             */
            public DisputeListParams.Created.Builder setLt(Long lt) {
                this.lt = lt;
                return this;
            }
             ...
             * Maximum value to filter by (inclusive).
             */
            public DisputeListParams.Created.Builder setLte(Long lte) {
                this.lte = lte;
                return this;
            }
