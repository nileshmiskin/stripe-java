...
public class CouponCreateParams extends ApiRequestParams {
    ...
    public static CouponCreateParams.Builder builder() {
        return new CouponCreateParams.Builder();
    }
    public static class Builder {
        private Long amountOff;
        private String currency;
        private CouponCreateParams.Duration duration;
         ...
         * Specifies how long the discount will be in effect. Can be `forever`, `once`, or `repeating`.
         */
        public CouponCreateParams.Builder setDuration(
            CouponCreateParams.Duration duration) {
         ...
         * Required only if `duration` is `repeating`, in which case it must be a positive integer that specifies the number of months the discount will be in effect.
         */
        public CouponCreateParams.Builder setDurationInMonths(
            Long durationInMonths) {
         ...
         */
        public CouponCreateParams.Builder addAllExpand(List<String> list) {
            if (this.expand == null) {
                this.expand = new ArrayList<>();
            }
         ...
         */
        public CouponCreateParams.Builder putExtraParam(
            String key,
            Object value) {
         ...
         */
        public CouponCreateParams.Builder putAllExtraParam(
         ...
         * Unique string of your choice that will be used to identify this coupon when applying it to a customer. This is often a specific code you'll give to your customer to use when signing up (e.g., `FALL25OFF`). If you don't want to specify a particular code, you can leave the ID blank and we'll generate a random code for you.
         */
        public CouponCreateParams.Builder setId(String id) {
            this.id = id;
            return this;
        }
         ...
         * A positive integer specifying the number of times the coupon can be redeemed before it's no longer valid. For example, you might have a 50% off coupon that the first 20 readers of your blog can use.
         */
        public CouponCreateParams.Builder setMaxRedemptions(
            Long maxRedemptions) {
         ...
         */
        public CouponCreateParams.Builder putMetadata(
            String key,
            String value) {
         ...
         */
        public CouponCreateParams.Builder putAllMetadata(
