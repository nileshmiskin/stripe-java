...
public class Source
    extends ApiResource
    implements MetadataStore<Source>, PaymentSource {
    ...
    Source.CodeVerificationFlow codeVerification;
    ...
    Source.ReceiverFlow receiver;
    @SerializedName("redirect")
    Source.RedirectFlow redirect;
    ...
    public static Source create(
        ...
        String url = String.format("%s/v1/sources", Stripe.getApiBase());
     ...
     */
    public static Source create(
        SourceCreateParams params) throws StripeException {
    ...
    public static Source retrieve(
        ...
        String url =
            String.format(
                "%s/v1/sources/%s",
                Stripe.getApiBase(),
                ApiResource.urlEncodeId(source)
            );
        return ApiResource.request(
    ...
    public SourceTransactionCollection sourceTransactions(
        ...
        String url =
            String.format(
                "%s/v1/sources/%s/source_transactions",
                Stripe.getApiBase(),
                ApiResource.urlEncodeId(this.getId())
            );
