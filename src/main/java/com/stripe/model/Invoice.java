...
public class Invoice
    extends ApiResource
    implements HasId, MetadataStore<Invoice> {
    ...
    Invoice.StatusTransitions statusTransitions;
    ...
    public static Invoice create(
        ...
        String url = String.format("%s/v1/invoices", Stripe.getApiBase());
     ...
     */
    public static Invoice create(
        InvoiceCreateParams params) throws StripeException {
     ...
     */
    public Invoice finalizeInvoice(
        InvoiceFinalizeInvoiceParams params) throws StripeException {
     ...
     */
    public static InvoiceCollection list(
        Map<String, Object> params) throws StripeException {
     ...
     */
    public static InvoiceCollection list(
        InvoiceListParams params) throws StripeException {
    ...
    public Invoice markUncollectible(
        ...
        String url =
            String.format(
                "%s/v1/invoices/%s/mark_uncollectible",
                Stripe.getApiBase(),
                ApiResource.urlEncodeId(this.getId())
            );
        return ApiResource.request(
     ...
     */
    public Invoice markUncollectible(
        InvoiceMarkUncollectibleParams params) throws StripeException {
     ...
     */
    public Invoice markUncollectible(
        InvoiceMarkUncollectibleParams params,
        RequestOptions options) throws StripeException {
    ...
    public static Invoice retrieve(
        ...
        String url =
            String.format(
                "%s/v1/invoices/%s",
                Stripe.getApiBase(),
                ApiResource.urlEncodeId(invoice)
            );
        return ApiResource.request(
     ...
     */
    public Invoice sendInvoice(
        InvoiceSendInvoiceParams params) throws StripeException {
     ...
     */
    public Invoice sendInvoice(
        InvoiceSendInvoiceParams params,
        RequestOptions options) throws StripeException {
    ...
    public static Invoice upcoming(
        ...
        String url =
            String.format("%s/v1/invoices/upcoming", Stripe.getApiBase());
        return ApiResource.request(
            ApiResource.RequestMethod.GET,
            url,
            params,
     ...
     */
    public static Invoice upcoming(
        InvoiceUpcomingParams params) throws StripeException {
     ...
     */
    public Invoice voidInvoice(
        InvoiceVoidInvoiceParams params) throws StripeException {
     ...
     */
    public Invoice voidInvoice(
        InvoiceVoidInvoiceParams params,
        RequestOptions options) throws StripeException {
