...
public class Reader extends ApiResource implements HasId {
    ...
    public static Reader create(
        ...
        String url =
            String.format("%s/v1/terminal/readers", Stripe.getApiBase());
     ...
     */
    public static Reader create(
        ReaderCreateParams params) throws StripeException {
     ...
     * <p>Deletes a <code>Reader</code> object.</p>
     */
    public Reader delete(
        Map<String, Object> params,
        RequestOptions options) throws StripeException {

        String url =
            String.format(
                "%s/v1/terminal/readers/%s",
                Stripe.getApiBase(),
     ...
     */
    public static ReaderCollection list(
        Map<String, Object> params) throws StripeException {
     ...
     */
    public static ReaderCollection list(
        ReaderListParams params) throws StripeException {
