...
public class Dispute
    ...
    public static class Evidence extends StripeObject {
        ...
        public void setCustomerSignature(String id) {
            this.customerSignature =
                ApiResource.setExpandableFieldId(id, this.customerSignature);
        }
        /**
        ...
        public void setDuplicateChargeDocumentationObject(
        ...
        public void setRefundPolicy(String id) {
            this.refundPolicy =
                ApiResource.setExpandableFieldId(id, this.refundPolicy);
        }
        /**
        ...
        public void setServiceDocumentation(String id) {
            this.serviceDocumentation =
                ApiResource.setExpandableFieldId(id, this.serviceDocumentation);
        }
        /**
        ...
        public void setUncategorizedFile(String id) {
            this.uncategorizedFile =
                ApiResource.setExpandableFieldId(id, this.uncategorizedFile);
        }
        /**
    ...
    public static DisputeCollection list(
        ...
        String url = String.format("%s/v1/disputes", Stripe.getApiBase());
     ...
     */
    public static DisputeCollection list(
        DisputeListParams params) throws StripeException {
