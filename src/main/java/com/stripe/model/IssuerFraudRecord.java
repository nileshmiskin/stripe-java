...
public class IssuerFraudRecord extends ApiResource implements HasId {
    ...
    public static IssuerFraudRecordCollection list(
        ...
        String url =
            String.format("%s/v1/issuer_fraud_records", Stripe.getApiBase());
     ...
     */
    public static IssuerFraudRecordCollection list(
        IssuerFraudRecordListParams params) throws StripeException {
     ...
     */
    public static IssuerFraudRecordCollection list(
        IssuerFraudRecordListParams params,
        RequestOptions options) throws StripeException {
    ...
    public static IssuerFraudRecord retrieve(
        String issuerFraudRecord) throws StripeException {
    ...
    public static IssuerFraudRecord retrieve(
        ...
        String url =
            String.format(
                "%s/v1/issuer_fraud_records/%s",
                Stripe.getApiBase(),
                ApiResource.urlEncodeId(issuerFraudRecord)
            );
