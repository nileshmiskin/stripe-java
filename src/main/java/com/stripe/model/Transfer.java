...
public class Transfer
    ...
    public void setDestinationPayment(String id) {
        this.destinationPayment =
            ApiResource.setExpandableFieldId(id, this.destinationPayment);
    }
    /**
    ...
    public void setSourceTransaction(String id) {
        this.sourceTransaction =
            ApiResource.setExpandableFieldId(id, this.sourceTransaction);
    }
    /**
    ...
    public static Transfer create(
        ...
        String url = String.format("%s/v1/transfers", Stripe.getApiBase());
     ...
     */
    public static Transfer create(
        TransferCreateParams params) throws StripeException {
     ...
     */
    public static TransferCollection list(
        TransferListParams params) throws StripeException {
    ...
    public static Transfer retrieve(
        ...
        String url =
            String.format(
                "%s/v1/transfers/%s",
                Stripe.getApiBase(),
                ApiResource.urlEncodeId(transfer)
            );
        return ApiResource.request(
