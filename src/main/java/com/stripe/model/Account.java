...
public class Account
    extends ApiResource
    implements MetadataStore<Account>, PaymentSource {
    ...
    public static class SettingsCardPayments extends StripeObject {
        ...
        Account.DeclineChargeOn declineOn;
    ...
    public static class Settings extends StripeObject {
        ...
        Account.SettingsBranding branding;
        @SerializedName("card_payments")
        Account.SettingsCardPayments cardPayments;
        @SerializedName("dashboard")
        Account.SettingsDashboard dashboard;
        @SerializedName("payments")
        Account.SettingsPayments payments;
        @SerializedName("payouts")
        Account.SettingsPayouts payouts;
    ...
    public static Account create(
        ...
        String url = String.format("%s/v1/accounts", Stripe.getApiBase());
     ...
     */
    public static Account create(
        AccountCreateParams params) throws StripeException {
     ...
     */
    public static AccountCollection list(
        AccountListParams params) throws StripeException {
     ...
     */
    public PersonCollection persons(
        AccountPersonsParams params) throws StripeException {
    ...
    public static Account retrieve(
        ...
        String url = String.format("%s/v1/account", Stripe.getApiBase());
        return ApiResource.request(
