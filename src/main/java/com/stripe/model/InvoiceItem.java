...
public class InvoiceItem
    extends ApiResource
    implements HasId, MetadataStore<InvoiceItem> {
    ...
    public static InvoiceItem create(
        ...
        String url = String.format("%s/v1/invoiceitems", Stripe.getApiBase());
     ...
     */
    public static InvoiceItem create(
        InvoiceItemCreateParams params) throws StripeException {
     ...
     */
    public static InvoiceItemCollection list(
        InvoiceItemListParams params) throws StripeException {
    ...
    public static InvoiceItem retrieve(
        String invoiceitem) throws StripeException {
    ...
    public static InvoiceItem retrieve(
        ...
        String url =
            String.format(
                "%s/v1/invoiceitems/%s",
                Stripe.getApiBase(),
                ApiResource.urlEncodeId(invoiceitem)
            );
        return ApiResource.request(
     ...
     */
    public InvoiceItem update(
        InvoiceItemUpdateParams params) throws StripeException {
