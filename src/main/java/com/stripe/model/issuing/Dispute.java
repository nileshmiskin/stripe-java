...
public class Dispute
    extends ApiResource
    implements HasId, MetadataStore<Dispute> {
    ...
    public void setDisputedTransaction(String id) {
        this.disputedTransaction =
            ApiResource.setExpandableFieldId(id, this.disputedTransaction);
    }
    /**
    ...
    public void setDisputedTransactionObject(Transaction expandableObject) {
        this.disputedTransaction =
            new ExpandableField<Transaction>(
    ...
    public static Dispute create(
        ...
        String url =
            String.format("%s/v1/issuing/disputes", Stripe.getApiBase());
     ...
     */
    public static Dispute create(
        DisputeCreateParams params) throws StripeException {
