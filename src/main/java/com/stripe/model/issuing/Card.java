...
public class Card extends ApiResource implements HasId, MetadataStore<Card> {
    ...
    Card.AuthorizationControls authorizationControls;
    ...
    public void setReplacementFor(String id) {
        this.replacementFor =
            ApiResource.setExpandableFieldId(id, this.replacementFor);
    }
    /**
    ...
    public static Card create(
        ...
        String url = String.format("%s/v1/issuing/cards", Stripe.getApiBase());
     ...
     */
    public CardDetails details(
        CardDetailsParams params) throws StripeException {
     ...
     */
    public static CardCollection list(
        Map<String, Object> params) throws StripeException {
     ...
     */
    public static CardCollection list(
        CardListParams params) throws StripeException {
    ...
    public static Card retrieve(
        ...
        String url =
            String.format(
                "%s/v1/issuing/cards/%s",
                Stripe.getApiBase(),
                ApiResource.urlEncodeId(card)
            );
        return ApiResource.request(
            ApiResource.RequestMethod.GET,
            url,
