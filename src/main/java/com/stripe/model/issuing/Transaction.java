...
public class Transaction
    ...
    public void setAuthorizationObject(Authorization expandableObject) {
        this.authorization =
            new ExpandableField<Authorization>(
    ...
    public static TransactionCollection list(
        ...
        String url =
            String.format("%s/v1/issuing/transactions", Stripe.getApiBase());
     ...
     */
    public static TransactionCollection list(
        TransactionListParams params) throws StripeException {
    ...
    public static Transaction retrieve(
        String transaction) throws StripeException {
     ...
     */
    public Transaction update(
        TransactionUpdateParams params) throws StripeException {
