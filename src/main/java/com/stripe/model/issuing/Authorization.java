...
public class Authorization
    ...
    Authorization.VerificationData verificationData;
    ...
    public void setCardholderObject(Cardholder expandableObject) {
        this.cardholder =
            new ExpandableField<Cardholder>(
    ...
    public Authorization approve(
        ...
        String url =
            String.format(
                "%s/v1/issuing/authorizations/%s/approve",
                Stripe.getApiBase(),
     ...
     */
    public Authorization approve(
        AuthorizationApproveParams params) throws StripeException {
     ...
     */
    public Authorization approve(
        AuthorizationApproveParams params,
        RequestOptions options) throws StripeException {
    ...
    public Authorization decline(
        ...
        String url =
            String.format(
                "%s/v1/issuing/authorizations/%s/decline",
                Stripe.getApiBase(),
                ApiResource.urlEncodeId(this.getId())
            );
        return ApiResource.request(
     ...
     */
    public Authorization decline(
        AuthorizationDeclineParams params) throws StripeException {
     ...
     */
    public static AuthorizationCollection list(
        Map<String, Object> params) throws StripeException {
    ...
    public static AuthorizationCollection list(
        ...
        String url =
            String.format("%s/v1/issuing/authorizations", Stripe.getApiBase());
     ...
     */
    public static AuthorizationCollection list(
        AuthorizationListParams params) throws StripeException {
    ...
    public static Authorization retrieve(
        String authorization) throws StripeException {
     ...
     */
    public Authorization update(
        AuthorizationUpdateParams params) throws StripeException {
