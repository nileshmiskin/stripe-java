...
public class Cardholder
    ...
    Cardholder.AuthorizationControls authorizationControls;
    ...
    public static Cardholder create(
        ...
        String url =
            String.format("%s/v1/issuing/cardholders", Stripe.getApiBase());
     ...
     */
    public static Cardholder create(
        CardholderCreateParams params) throws StripeException {
     ...
     */
    public static CardholderCollection list(
        Map<String, Object> params) throws StripeException {
     ...
     */
    public static CardholderCollection list(
        CardholderListParams params) throws StripeException {
    ...
    public static Cardholder retrieve(
        String cardholder) throws StripeException {
    ...
    public static Cardholder retrieve(
        ...
        String url =
            String.format(
                "%s/v1/issuing/cardholders/%s",
                Stripe.getApiBase(),
                ApiResource.urlEncodeId(cardholder)
            );
        return ApiResource.request(
     ...
     */
    public Cardholder update(
        CardholderUpdateParams params) throws StripeException {
