...
public class SubscriptionItem
    ...
    public static SubscriptionItem create(
        ...
        String url =
            String.format("%s/v1/subscription_items", Stripe.getApiBase());
     ...
     */
    public static SubscriptionItem create(
        SubscriptionItemCreateParams params) throws StripeException {
     ...
     */
    public SubscriptionItem delete(
        SubscriptionItemDeleteParams params) throws StripeException {
     ...
     */
    public SubscriptionItem delete(
        SubscriptionItemDeleteParams params,
        RequestOptions options) throws StripeException {
     ...
     */
    public static SubscriptionItemCollection list(
        SubscriptionItemListParams params) throws StripeException {
    ...
    public static SubscriptionItem retrieve(
        String item) throws StripeException {
     ...
     */
    public SubscriptionItem update(
        SubscriptionItemUpdateParams params) throws StripeException {
    ...
    public UsageRecordSummaryCollection usageRecordSummaries(
        ...
        String url =
            String.format(
                "%s/v1/subscription_items/%s/usage_record_summaries",
                Stripe.getApiBase(),
                ApiResource.urlEncodeId(this.getId())
            );
        return ApiResource.requestCollection(
     ...
     */
    public UsageRecordSummaryCollection usageRecordSummaries(
        SubscriptionItemUsageRecordSummariesParams params) throws
            StripeException {
