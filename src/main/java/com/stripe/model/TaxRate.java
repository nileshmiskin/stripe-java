...
public class TaxRate
    extends ApiResource
    implements HasId, MetadataStore<TaxRate> {
    ...
    public static TaxRate create(
        ...
        String url = String.format("%s/v1/tax_rates", Stripe.getApiBase());
     ...
     */
    public static TaxRate create(
        TaxRateCreateParams params) throws StripeException {
     ...
     */
    public static TaxRateCollection list(
        Map<String, Object> params) throws StripeException {
     ...
     */
    public static TaxRateCollection list(
        TaxRateListParams params) throws StripeException {
    ...
    public static TaxRate retrieve(
        ...
        String url =
            String.format(
                "%s/v1/tax_rates/%s",
                Stripe.getApiBase(),
                ApiResource.urlEncodeId(taxRate)
            );
        return ApiResource.request(
