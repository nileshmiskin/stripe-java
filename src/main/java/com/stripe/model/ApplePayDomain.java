...
public class ApplePayDomain extends ApiResource implements HasId {
    ...
    public static ApplePayDomain create(
        ...
        String url =
            String.format("%s/v1/apple_pay/domains", Stripe.getApiBase());
     ...
     */
    public static ApplePayDomain create(
        ApplePayDomainCreateParams params) throws StripeException {
    ...
    public static ApplePayDomain retrieve(
        String domain) throws StripeException {
    ...
    public static ApplePayDomain retrieve(
        ...
        String url =
            String.format(
                "%s/v1/apple_pay/domains/%s",
                Stripe.getApiBase(),
                ApiResource.urlEncodeId(domain)
            );
        return ApiResource.request(
