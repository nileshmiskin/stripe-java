...
public class ExchangeRate extends ApiResource implements HasId {
     ...
     */
    public static ExchangeRateCollection list(
    ...
    public static ExchangeRateCollection list(
        ...
        String url = String.format("%s/v1/exchange_rates", Stripe.getApiBase());
     ...
     */
    public static ExchangeRateCollection list(
        ExchangeRateListParams params) throws StripeException {
    ...
    public static ExchangeRate retrieve(
        ...
        String url =
            String.format(
                "%s/v1/exchange_rates/%s",
                Stripe.getApiBase(),
                ApiResource.urlEncodeId(currency)
            );
