...
public class Recipient
    extends ApiResource
    implements HasId, MetadataStore<Recipient> {
    ...
    public void setDefaultCard(String id) {
        this.defaultCard =
            ApiResource.setExpandableFieldId(id, this.defaultCard);
    }
    /**
    ...
    public void setRolledBackFrom(String id) {
        this.rolledBackFrom =
            ApiResource.setExpandableFieldId(id, this.rolledBackFrom);
    }
    /**
    ...
    public static Recipient create(
        ...
        String url = String.format("%s/v1/recipients", Stripe.getApiBase());
     ...
     */
    public static Recipient create(
        RecipientCreateParams params) throws StripeException {
     ...
     */
    public static RecipientCollection list(
        RecipientListParams params) throws StripeException {
     ...
     */
    public Recipient update(
        RecipientUpdateParams params) throws StripeException {
