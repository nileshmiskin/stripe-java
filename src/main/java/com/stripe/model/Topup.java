...
public class Topup
    extends ApiResource
    implements MetadataStore<Topup>, BalanceTransactionSource {
    ...
    public static Topup create(
        ...
        String url = String.format("%s/v1/topups", Stripe.getApiBase());
        return ApiResource.request(
            ApiResource.RequestMethod.POST,
            url,
            params,
     ...
     */
    public static Topup create(
        TopupCreateParams params) throws StripeException {
     ...
     */
    public static TopupCollection list(
        Map<String, Object> params) throws StripeException {
     ...
     */
    public static TopupCollection list(
        TopupListParams params) throws StripeException {
