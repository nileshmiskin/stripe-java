...
public class PaymentMethod
    extends ApiResource
    implements HasId, MetadataStore<PaymentMethod> {
    ...
    public static class Card extends StripeObject {
        ...
        public static class Wallet extends StripeObject {
            ...
            PaymentMethod.Card.Wallet.AmexExpressCheckout amexExpressCheckout;
            @SerializedName("apple_pay")
            PaymentMethod.Card.Wallet.ApplePay applePay;
            ...
            PaymentMethod.Card.Wallet.GooglePay googlePay;
            @SerializedName("masterpass")
            PaymentMethod.Card.Wallet.Masterpass masterpass;
            @SerializedName("samsung_pay")
            PaymentMethod.Card.Wallet.SamsungPay samsungPay;
            ...
            PaymentMethod.Card.Wallet.VisaCheckout visaCheckout;
     ...
     */
    public PaymentMethod attach(
        PaymentMethodAttachParams params) throws StripeException {
    ...
    public static PaymentMethod create(
        ...
        String url =
            String.format("%s/v1/payment_methods", Stripe.getApiBase());
        return ApiResource.request(
            ApiResource.RequestMethod.POST,
            url,
            params,
     ...
     */
    public static PaymentMethod create(
        PaymentMethodCreateParams params) throws StripeException {
     ...
     */
    public PaymentMethod detach(
        PaymentMethodDetachParams params) throws StripeException {
    ...
    public static PaymentMethod retrieve(
        ...
        String url =
            String.format(
                "%s/v1/payment_methods/%s",
                Stripe.getApiBase(),
                ApiResource.urlEncodeId(paymentMethod)
            );
        return ApiResource.request(
     ...
     */
    public PaymentMethod update(
        PaymentMethodUpdateParams params) throws StripeException {
