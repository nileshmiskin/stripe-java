...
public class Payout
    extends ApiResource
    implements MetadataStore<Payout>, BalanceTransactionSource {
    ...
    public void setDestinationObject(ExternalAccount expandableObject) {
        this.destination =
            new ExpandableField<ExternalAccount>(
                expandableObject.getId(),
                expandableObject
            );
    }
    ...
    public static Payout create(
        ...
        String url = String.format("%s/v1/payouts", Stripe.getApiBase());
        return ApiResource.request(
            ApiResource.RequestMethod.POST,
            url,
            params,
     ...
     */
    public static Payout create(
        PayoutCreateParams params) throws StripeException {
     ...
     */
    public static PayoutCollection list(
        Map<String, Object> params) throws StripeException {
     ...
     */
    public static PayoutCollection list(
        PayoutListParams params) throws StripeException {
    ...
    public static Payout retrieve(
        ...
        String url =
            String.format(
                "%s/v1/payouts/%s",
                Stripe.getApiBase(),
                ApiResource.urlEncodeId(payout)
            );
        return ApiResource.request(
