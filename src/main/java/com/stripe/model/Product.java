...
public class Product
    extends ApiResource
    implements HasId, MetadataStore<Product> {
    ...
    public static Product create(
        ...
        String url = String.format("%s/v1/products", Stripe.getApiBase());
     ...
     */
    public static Product create(
        ProductCreateParams params) throws StripeException {
     ...
     */
    public static ProductCollection list(
        Map<String, Object> params) throws StripeException {
     ...
     */
    public static ProductCollection list(
        ProductListParams params) throws StripeException {
