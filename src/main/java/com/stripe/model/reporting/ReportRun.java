...
public class ReportRun extends ApiResource implements HasId {
 ...
 `status=failed`).
    ...
    ReportRun.Parameters parameters;
 ...
 `status=succeeded`). Measured in seconds since the Unix epoch.
    ...
    public static ReportRun create(
        ...
        String url =
            String.format("%s/v1/reporting/report_runs", Stripe.getApiBase());
     ...
     */
    public static ReportRun create(
        ReportRunCreateParams params) throws StripeException {
     ...
     */
    public static ReportRunCollection list(
        Map<String, Object> params) throws StripeException {
     ...
     */
    public static ReportRunCollection list(
        ReportRunListParams params) throws StripeException {
    ...
    public static ReportRun retrieve(
        ...
        String url =
            String.format(
                "%s/v1/reporting/report_runs/%s",
                Stripe.getApiBase(),
                ApiResource.urlEncodeId(reportRun)
            );
        return ApiResource.request(
