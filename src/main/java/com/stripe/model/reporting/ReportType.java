...
public class ReportType extends ApiResource implements HasId {
    ...
    public static ReportTypeCollection list(
        ...
        String url =
            String.format("%s/v1/reporting/report_types", Stripe.getApiBase());
     ...
     */
    public static ReportTypeCollection list(
        ReportTypeListParams params) throws StripeException {
    ...
    public static ReportType retrieve(
        String reportType) throws StripeException {
    ...
    public static ReportType retrieve(
        ...
        String url =
            String.format(
                "%s/v1/reporting/report_types/%s",
                Stripe.getApiBase(),
                ApiResource.urlEncodeId(reportType)
            );
