...
public class CreditNote
    extends ApiResource
    implements HasId, MetadataStore<CreditNote> {
    ...
    public static CreditNote create(
        ...
        String url = String.format("%s/v1/credit_notes", Stripe.getApiBase());
     ...
     */
    public static CreditNote create(
        CreditNoteCreateParams params) throws StripeException {
     ...
     */
    public static CreditNoteCollection list(
        Map<String, Object> params) throws StripeException {
     ...
     */
    public static CreditNoteCollection list(
        CreditNoteListParams params) throws StripeException {
     ...
     */
    public CreditNote update(
        CreditNoteUpdateParams params) throws StripeException {
     ...
     */
    public CreditNote voidCreditNote(
        CreditNoteVoidCreditNoteParams params) throws StripeException {
