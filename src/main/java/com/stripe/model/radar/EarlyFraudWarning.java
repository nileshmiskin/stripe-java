...
public class EarlyFraudWarning extends ApiResource implements HasId {
    ...
    public static EarlyFraudWarningCollection list(
        ...
        String url =
            String.format(
                "%s/v1/radar/early_fraud_warnings",
                Stripe.getApiBase()
            );
     ...
     */
    public static EarlyFraudWarningCollection list(
        EarlyFraudWarningListParams params) throws StripeException {
    ...
    public static EarlyFraudWarning retrieve(
        String earlyFraudWarning) throws StripeException {
    ...
    public static EarlyFraudWarning retrieve(
        ...
        String url =
            String.format(
                "%s/v1/radar/early_fraud_warnings/%s",
                Stripe.getApiBase(),
                ApiResource.urlEncodeId(earlyFraudWarning)
            );
