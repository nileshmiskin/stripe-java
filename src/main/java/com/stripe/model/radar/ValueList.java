...
public class ValueList
    extends ApiResource
    implements HasId, MetadataStore<ValueList> {
    ...
    public static ValueList create(
        ...
        String url =
            String.format("%s/v1/radar/value_lists", Stripe.getApiBase());
     ...
     */
    public static ValueList create(
        ValueListCreateParams params) throws StripeException {
     ...
     */
    public static ValueListCollection list(
        Map<String, Object> params) throws StripeException {
     ...
     */
    public static ValueListCollection list(
        ValueListListParams params) throws StripeException {
    ...
    public static ValueList retrieve(
        ...
        String url =
            String.format(
                "%s/v1/radar/value_lists/%s",
                Stripe.getApiBase(),
                ApiResource.urlEncodeId(valueList)
            );
        return ApiResource.request(
     ...
     */
    public ValueList update(
        ValueListUpdateParams params) throws StripeException {
