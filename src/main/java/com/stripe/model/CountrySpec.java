...
public class CountrySpec extends ApiResource implements HasId {
    ...
    CountrySpec.VerificationFields verificationFields;
    ...
    public static class VerificationFields extends StripeObject {
        ...
        CountrySpec.VerificationFields.Details company;
        @SerializedName("individual")
        CountrySpec.VerificationFields.Details individual;
    ...
    public static CountrySpecCollection list(
        ...
        String url = String.format("%s/v1/country_specs", Stripe.getApiBase());
     ...
     */
    public static CountrySpecCollection list(
        CountrySpecListParams params) throws StripeException {
    ...
    public static CountrySpec retrieve(
        ...
        String url =
            String.format(
                "%s/v1/country_specs/%s",
                Stripe.getApiBase(),
                ApiResource.urlEncodeId(country)
            );
