...
public class PaymentIntent
    extends ApiResource
    implements HasId, MetadataStore<PaymentIntent> {
...
Change `capture_method` to manual if you wish to [separate authorization and capture](https://stripe.com/docs/payments/payment-intents/creating-payment-intents#separate-authorization-and-capture) for payment methods that support this.
    ...
    /**
     * The client secret of this PaymentIntent. Used for client-side retrieval using a publishable key. Please refer to our [automatic confirmation quickstart guide](https://stripe.com/docs/payments/payment-intents/quickstart#automatic-confirmation-flow) to learn about how `client_secret` should be handled.
     */
...
Learn more about the different [confirmation flows](https://stripe.com/docs/payments/payment-intents#one-time-payments).
    ...
    /**
     * Status of this PaymentIntent, one of `requires_payment_method`, `requires_confirmation`, `requires_action`, `processing`, `requires_capture`, `canceled`, or `succeeded`. Read more about each PaymentIntent [status](https://stripe.com/docs/payments/payment-intents/status).
     */
    ...
    public void setPaymentMethod(String id) {
        this.paymentMethod =
            ApiResource.setExpandableFieldId(id, this.paymentMethod);
    }
    /**
...
payment success.
     ...
     */
    public PaymentIntent cancel(
        PaymentIntentCancelParams params) throws StripeException {
     ...
     */
    public PaymentIntent capture(
        PaymentIntentCaptureParams params) throws StripeException {
     ...
     * attempt. Read the <a href="/docs/payments/payment-intents/quickstart#manual-confirmation-flow">expanded documentation</a>
     ...
     */
    public PaymentIntent confirm(
        PaymentIntentConfirmParams params) throws StripeException {
    ...
    public static PaymentIntent create(
        ...
        String url =
            String.format("%s/v1/payment_intents", Stripe.getApiBase());
        return ApiResource.request(
            ApiResource.RequestMethod.POST,
            url,
            params,
     ...
     */
    public static PaymentIntent create(
        PaymentIntentCreateParams params) throws StripeException {
     ...
     */
    public static PaymentIntentCollection list(
        Map<String, Object> params) throws StripeException {
     ...
     */
    public static PaymentIntentCollection list(
        PaymentIntentListParams params) throws StripeException {
     ...
     */
    public PaymentIntent update(
        PaymentIntentUpdateParams params) throws StripeException {
