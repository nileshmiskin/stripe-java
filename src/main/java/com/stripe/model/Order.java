...
public class Order extends ApiResource implements HasId, MetadataStore<Order> {
    ...
    Order.StatusTransitions statusTransitions;
    ...
    public static class ShippingMethod extends StripeObject implements HasId {
        ...
        Order.ShippingMethod.DeliveryEstimate deliveryEstimate;
    ...
    public static Order create(
        ...
        String url = String.format("%s/v1/orders", Stripe.getApiBase());
     ...
     */
    public static Order create(
        OrderCreateParams params) throws StripeException {
     ...
     */
    public static OrderCollection list(
        Map<String, Object> params) throws StripeException {
     ...
     */
    public static OrderCollection list(
        OrderListParams params) throws StripeException {
     ...
     */
    public OrderReturn returnOrder(
        OrderReturnOrderParams params) throws StripeException {
