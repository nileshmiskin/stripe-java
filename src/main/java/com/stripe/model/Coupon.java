...
public class Coupon
    extends ApiResource
    implements HasId, MetadataStore<Coupon> {
    ...
    public static Coupon create(
        ...
        String url = String.format("%s/v1/coupons", Stripe.getApiBase());
     ...
     */
    public static Coupon create(
        CouponCreateParams params) throws StripeException {
     ...
     */
    public static CouponCollection list(
        CouponListParams params) throws StripeException {
    ...
    public static Coupon retrieve(
        ...
        String url =
            String.format(
                "%s/v1/coupons/%s",
                Stripe.getApiBase(),
                ApiResource.urlEncodeId(coupon)
            );
        return ApiResource.request(
