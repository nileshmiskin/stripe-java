...
public class TransferReversalCollection
     ...
     */
    public TransferReversal create(
        TransferReversalCollectionCreateParams params) throws StripeException {
     ...
     */
    public TransferReversalCollection list(
        TransferReversalCollectionListParams params) throws StripeException {
    ...
    public TransferReversal retrieve(
        String id,
        TransferReversalCollectionRetrieveParams params,
        RequestOptions options) throws StripeException {
