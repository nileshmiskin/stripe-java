...
public class ThreeDSecure extends ApiResource implements HasId {
    ...
    public static ThreeDSecure create(
        ...
        String url = String.format("%s/v1/3d_secure", Stripe.getApiBase());
     ...
     */
    public static ThreeDSecure create(
        ThreeDSecureCreateParams params) throws StripeException {
    ...
    public static ThreeDSecure retrieve(
        String threeDSecure) throws StripeException {
    ...
    public static ThreeDSecure retrieve(
        ...
        String url =
            String.format(
                "%s/v1/3d_secure/%s",
                Stripe.getApiBase(),
                ApiResource.urlEncodeId(threeDSecure)
            );
        return ApiResource.request(
