...
public class Plan extends ApiResource implements HasId, MetadataStore<Plan> {
    ...
    public static Plan create(
        ...
        String url = String.format("%s/v1/plans", Stripe.getApiBase());
     ...
     */
    public static PlanCollection list(
        Map<String, Object> params) throws StripeException {
     ...
     */
    public static PlanCollection list(
        PlanListParams params) throws StripeException {
