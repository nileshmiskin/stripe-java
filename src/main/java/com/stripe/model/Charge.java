...
public class Charge
    extends ApiResource
    implements MetadataStore<Charge>, BalanceTransactionSource {
    ...
    Charge.FraudDetails fraudDetails;
    ...
    Charge.PaymentMethodDetails paymentMethodDetails;
    ...
    Charge.TransferData transferData;
    ...
    public void setApplicationObject(Application expandableObject) {
        this.application =
            new ExpandableField<Application>(
    ...
    public void setApplicationFee(String id) {
        this.applicationFee =
            ApiResource.setExpandableFieldId(id, this.applicationFee);
    }
    /**
    ...
    public void setApplicationFeeObject(ApplicationFee expandableObject) {
        this.applicationFee =
            new ExpandableField<ApplicationFee>(
                expandableObject.getId(),
                expandableObject
            );
    }
    ...
    public void setDestination(String id) {
        this.destination =
            ApiResource.setExpandableFieldId(id, this.destination);
    }
    /**
    ...
    public void setSourceTransfer(String id) {
        this.sourceTransfer =
            ApiResource.setExpandableFieldId(id, this.sourceTransfer);
    }
    /**
    ...
    public static class PaymentMethodDetails extends StripeObject {
        ...
        Charge.PaymentMethodDetails.AchCreditTransfer achCreditTransfer;
        @SerializedName("ach_debit")
        Charge.PaymentMethodDetails.AchDebit achDebit;
        @SerializedName("acss_debit")
        Charge.PaymentMethodDetails.AcssDebit acssDebit;
        @SerializedName("alipay")
        Charge.PaymentMethodDetails.Alipay alipay;
        @SerializedName("bancontact")
        Charge.PaymentMethodDetails.Bancontact bancontact;
        @SerializedName("bitcoin")
        Charge.PaymentMethodDetails.Bitcoin bitcoin;
        @SerializedName("card")
        Charge.PaymentMethodDetails.Card card;
        @SerializedName("card_present")
        Charge.PaymentMethodDetails.CardPresent cardPresent;
        @SerializedName("eps")
        Charge.PaymentMethodDetails.Eps eps;
        @SerializedName("giropay")
        Charge.PaymentMethodDetails.Giropay giropay;
        @SerializedName("ideal")
        Charge.PaymentMethodDetails.Ideal ideal;
        @SerializedName("multibanco")
        Charge.PaymentMethodDetails.Multibanco multibanco;
        @SerializedName("p24")
        Charge.PaymentMethodDetails.P24 p24;
        @SerializedName("sepa_debit")
        Charge.PaymentMethodDetails.SepaDebit sepaDebit;
        @SerializedName("sofort")
        Charge.PaymentMethodDetails.Sofort sofort;
        @SerializedName("stripe_account")
        Charge.PaymentMethodDetails.StripeAccount stripeAccount;
...
It contains information specific to the payment method.
        ...
        Charge.PaymentMethodDetails.Wechat wechat;
...
(if supported) at the time of authorization or settlement. They cannot be set or mutated.
        ...
        public static class Card extends StripeObject {
            ...
            Charge.PaymentMethodDetails.Card.Checks checks;
            ...
            Charge.PaymentMethodDetails.Card.Wallet wallet;
            ...
            public static class Wallet extends StripeObject {
                ...
                Charge.PaymentMethodDetails.Card.Wallet.AmexExpressCheckout amexExpressCheckout;
                @SerializedName("apple_pay")
                Charge.PaymentMethodDetails.Card.Wallet.ApplePay applePay;
                ...
                Charge.PaymentMethodDetails.Card.Wallet.GooglePay googlePay;
                @SerializedName("masterpass")
                Charge.PaymentMethodDetails.Card.Wallet.Masterpass masterpass;
                @SerializedName("samsung_pay")
                Charge.PaymentMethodDetails.Card.Wallet.SamsungPay samsungPay;
                ...
                Charge.PaymentMethodDetails.Card.Wallet.VisaCheckout visaCheckout;
        ...
        public static class CardPresent extends StripeObject {
            ...
            Charge.PaymentMethodDetails.CardPresent.Receipt receipt;
...
(if supported) at the time of authorization or settlement. They cannot be set or mutated.
    ...
    public static Charge create(
        ...
        String url = String.format("%s/v1/charges", Stripe.getApiBase());
        return ApiResource.request(
            ApiResource.RequestMethod.POST,
            url,
            params,
     ...
     */
    public static Charge create(
        ChargeCreateParams params) throws StripeException {
     ...
     */
    public static ChargeCollection list(
        ChargeListParams params) throws StripeException {
    ...
    public static Charge retrieve(
        ...
        String url =
            String.format(
                "%s/v1/charges/%s",
                Stripe.getApiBase(),
                ApiResource.urlEncodeId(charge)
            );
        return ApiResource.request(
