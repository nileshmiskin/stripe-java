...
public class WebhookEndpoint extends ApiResource implements HasId {
    ...
    public static WebhookEndpoint create(
        ...
        String url =
            String.format("%s/v1/webhook_endpoints", Stripe.getApiBase());
     ...
     */
    public static WebhookEndpoint create(
        WebhookEndpointCreateParams params) throws StripeException {
     ...
     */
    public static WebhookEndpointCollection list(
        WebhookEndpointListParams params) throws StripeException {
    ...
    public static WebhookEndpoint retrieve(
        String webhookEndpoint) throws StripeException {
    ...
    public static WebhookEndpoint retrieve(
        ...
        String url =
            String.format(
                "%s/v1/webhook_endpoints/%s",
                Stripe.getApiBase(),
                ApiResource.urlEncodeId(webhookEndpoint)
            );
        return ApiResource.request(
     ...
     */
    public WebhookEndpoint update(
        WebhookEndpointUpdateParams params) throws StripeException {
