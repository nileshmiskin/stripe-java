...
public class Subscription
    extends ApiResource
    implements HasId, MetadataStore<Subscription> {
...
If subscription `billing=send_invoice` it becomes `past_due` when its invoice is not paid by the due date, and `canceled` or `unpaid` if it is still not paid by an additional deadline after that. Note that when a subscription has a status of `unpaid`, no subsequent invoices will be attempted (invoices will be created, but then immediately automatically closed). After receiving updated payment information from a customer, you may choose to reopen and pay their closed invoices.
    ...
    public void setLatestInvoice(String id) {
        this.latestInvoice =
            ApiResource.setExpandableFieldId(id, this.latestInvoice);
    }
    /**
     ...
     */
    public Subscription cancel(
        SubscriptionCancelParams params) throws StripeException {
    ...
    public static Subscription create(
        ...
        String url = String.format("%s/v1/subscriptions", Stripe.getApiBase());
        return ApiResource.request(
     ...
     */
    public static Subscription create(
        SubscriptionCreateParams params) throws StripeException {
     ...
     */
    public static SubscriptionCollection list(
        Map<String, Object> params) throws StripeException {
     ...
     */
    public static SubscriptionCollection list(
        SubscriptionListParams params) throws StripeException {
    ...
    public static Subscription retrieve(
        String subscriptionExposedId) throws StripeException {
    ...
    public static Subscription retrieve(
        ...
        String url =
            String.format(
                "%s/v1/subscriptions/%s",
                Stripe.getApiBase(),
                ApiResource.urlEncodeId(subscriptionExposedId)
            );
        return ApiResource.request(
