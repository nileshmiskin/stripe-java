...
public class Review extends ApiResource implements HasId {
    ...
    Review.Location ipAddressLocation;
    ...
    public static ReviewCollection list(
        ...
        String url = String.format("%s/v1/reviews", Stripe.getApiBase());
     ...
     */
    public static ReviewCollection list(
        ReviewListParams params) throws StripeException {
    ...
    public static Review retrieve(
        ...
        String url =
            String.format(
                "%s/v1/reviews/%s",
                Stripe.getApiBase(),
                ApiResource.urlEncodeId(review)
            );
        return ApiResource.request(
