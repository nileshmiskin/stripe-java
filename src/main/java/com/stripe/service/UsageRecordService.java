...
/**
 * Service class for {@link UsageRecord}, and is now a preferred way to making API requests.The
 * original methods in model class will be marked deprecated in the next major version.
 */
public class UsageRecordService extends ApiService {
  /**
   ...
   */
  public UsageRecord create(String subscriptionItem, UsageRecordCreateParams params)
  ...
  public UsageRecord create(
      ...
      throws StripeException {
    String url = resourceUrl("/v1/subscription_items/%s/usage_records", subscriptionItem);
