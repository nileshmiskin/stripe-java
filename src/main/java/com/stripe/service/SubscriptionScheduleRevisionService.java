...
/**
 * Service class for {@link SubscriptionScheduleRevision}, and is now a preferred way to making API
 * requests.The original methods in model class will be marked deprecated in the next major version.
 */
